...
main(int argc, char **argv)
{
  ...
  4c:	b4858593          	addi	a1,a1,-1208 # b90 <uthread_self+0x14>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fc:	7b850513          	addi	a0,a0,1976 # bb0 <digits>
 400:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c8:	6ecb8b93          	addi	s7,s7,1772 # bb0 <digits>
 ...
 608:	5a490913          	addi	s2,s2,1444 # ba8 <uthread_self+0x2c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7a6:	87e78793          	addi	a5,a5,-1922 # 1020 <base>
...
000000000000082e <uswtch>:
 82e:	00153023          	sd	ra,0(a0)
 832:	00253423          	sd	sp,8(a0)
 836:	e900                	sd	s0,16(a0)
 838:	ed04                	sd	s1,24(a0)
 83a:	03253023          	sd	s2,32(a0)
 83e:	03353423          	sd	s3,40(a0)
 842:	03453823          	sd	s4,48(a0)
 846:	03553c23          	sd	s5,56(a0)
 84a:	05653023          	sd	s6,64(a0)
 84e:	05753423          	sd	s7,72(a0)
 852:	05853823          	sd	s8,80(a0)
 856:	05953c23          	sd	s9,88(a0)
 85a:	07a53023          	sd	s10,96(a0)
 85e:	07b53423          	sd	s11,104(a0)
 862:	0005b083          	ld	ra,0(a1)
 866:	0085b103          	ld	sp,8(a1)
 86a:	6980                	ld	s0,16(a1)
 86c:	6d84                	ld	s1,24(a1)
 86e:	0205b903          	ld	s2,32(a1)
 872:	0285b983          	ld	s3,40(a1)
 876:	0305ba03          	ld	s4,48(a1)
 87a:	0385ba83          	ld	s5,56(a1)
 87e:	0405bb03          	ld	s6,64(a1)
 882:	0485bb83          	ld	s7,72(a1)
 886:	0505bc03          	ld	s8,80(a1)
 88a:	0585bc83          	ld	s9,88(a1)
 88e:	0605bd03          	ld	s10,96(a1)
 892:	0685bd83          	ld	s11,104(a1)
 896:	8082                	ret

0000000000000898 <uthread_exit>:
...
void uthread_exit(){
 ...
 8a4:	32850513          	addi	a0,a0,808 # bc8 <digits+0x18>
 8a8:	00000097          	auipc	ra,0x0
 8ac:	de4080e7          	jalr	-540(ra) # 68c <printf>
    // Change the state of the current thread to FREE
    curr_thread->state = FREE;
 8b0:	00000517          	auipc	a0,0x0
 8b4:	75853503          	ld	a0,1880(a0) # 1008 <curr_thread>
 8b8:	6785                	lui	a5,0x1
 8ba:	97aa                	add	a5,a5,a0
 8bc:	fa07a223          	sw	zero,-92(a5) # fa4 <digits+0x3f4>
 ...
 8ca:	00000617          	auipc	a2,0x0
 8ce:	7d660613          	addi	a2,a2,2006 # 10a0 <uthreads_arr>
 8d2:	6805                	lui	a6,0x1
 8d4:	4889                	li	a7,2
 8d6:	a819                	j	8ec <uthread_exit+0x54>
    for (int i = curr_thread->id+1; count<MAX_UTHREADS;  count++,i=(i+1)%MAX_UTHREADS) {
 8d8:	2785                	addiw	a5,a5,1
 8da:	41f7d71b          	sraiw	a4,a5,0x1f
 8de:	01e7571b          	srliw	a4,a4,0x1e
 8e2:	9fb9                	addw	a5,a5,a4
 8e4:	8b8d                	andi	a5,a5,3
 8e6:	9f99                	subw	a5,a5,a4
 8e8:	36fd                	addiw	a3,a3,-1
 8ea:	ca9d                	beqz	a3,920 <uthread_exit+0x88>
        if (uthreads_arr[i].state == RUNNABLE &&
 8ec:	00779713          	slli	a4,a5,0x7
 8f0:	973e                	add	a4,a4,a5
 8f2:	0716                	slli	a4,a4,0x5
 8f4:	9732                	add	a4,a4,a2
 8f6:	9742                	add	a4,a4,a6
 8f8:	fa472703          	lw	a4,-92(a4)
 8fc:	fd171ee3          	bne	a4,a7,8d8 <uthread_exit+0x40>
 ...
 90c:	4f18                	lw	a4,24(a4)
        if (uthreads_arr[i].state == RUNNABLE &&
 90e:	fce375e3          	bgeu	t1,a4,8d8 <uthread_exit+0x40>
            next_thread = &uthreads_arr[i];
 912:	00779593          	slli	a1,a5,0x7
 916:	95be                	add	a1,a1,a5
 918:	0596                	slli	a1,a1,0x5
 91a:	95b2                	add	a1,a1,a2
            max_priority = uthreads_arr[i].priority;
 91c:	833a                	mv	t1,a4
 91e:	bf6d                	j	8d8 <uthread_exit+0x40>
        }
    }
    if (next_thread == (struct uthread *) 1) {
 920:	4785                	li	a5,1
 922:	02f58863          	beq	a1,a5,952 <uthread_exit+0xba>
 ...
 92c:	4685                	li	a3,1
 92e:	fad72223          	sw	a3,-92(a4)
    curr_thread = next_thread;
 932:	00000717          	auipc	a4,0x0
 936:	6cb73b23          	sd	a1,1750(a4) # 1008 <curr_thread>
    struct context *next_context = &next_thread->context;
 93a:	fa878793          	addi	a5,a5,-88 # fa8 <digits+0x3f8>
    uswtch(curr_context, next_context);
 93e:	95be                	add	a1,a1,a5
 940:	953e                	add	a0,a0,a5
 942:	00000097          	auipc	ra,0x0
 946:	eec080e7          	jalr	-276(ra) # 82e <uswtch>
}
 94a:	60a2                	ld	ra,8(sp)
 94c:	6402                	ld	s0,0(sp)
 ...
 958:	998080e7          	jalr	-1640(ra) # 2ec <exit>

000000000000095c <uthread_create>:
int uthread_create(void (*start_func)(), enum sched_priority priority) {
 ...
 966:	6e270713          	addi	a4,a4,1762 # 2044 <uthreads_arr+0xfa4>
 96a:	4781                	li	a5,0
 96c:	6605                	lui	a2,0x1
 96e:	02060613          	addi	a2,a2,32 # 1020 <base>
 972:	4811                	li	a6,4
        if (uthreads_arr[i].state == FREE) {
 974:	4314                	lw	a3,0(a4)
 976:	c699                	beqz	a3,984 <uthread_create+0x28>
    for (i = 0; i < MAX_UTHREADS; i++) {
 978:	2785                	addiw	a5,a5,1
 97a:	9732                	add	a4,a4,a2
 97c:	ff079ce3          	bne	a5,a6,974 <uthread_create+0x18>
        return -1;
 980:	557d                	li	a0,-1
 982:	a0b9                	j	9d0 <uthread_create+0x74>
            curr_thread = &uthreads_arr[i];
 984:	00779713          	slli	a4,a5,0x7
 988:	973e                	add	a4,a4,a5
 98a:	0716                	slli	a4,a4,0x5
 98c:	00000697          	auipc	a3,0x0
 990:	71468693          	addi	a3,a3,1812 # 10a0 <uthreads_arr>
 994:	9736                	add	a4,a4,a3
 996:	00000697          	auipc	a3,0x0
 99a:	66e6b923          	sd	a4,1650(a3) # 1008 <curr_thread>
    if (i >= MAX_UTHREADS) {
 99e:	468d                	li	a3,3
 9a0:	02f6cb63          	blt	a3,a5,9d6 <uthread_create+0x7a>
    curr_thread->id = i; 
 9a4:	c31c                	sw	a5,0(a4)
    curr_thread->priority = priority;
 9a6:	6685                	lui	a3,0x1
 9a8:	00d707b3          	add	a5,a4,a3
 9ac:	cf8c                	sw	a1,24(a5)
    curr_thread->context.ra = (uint64) start_func;
 9ae:	faa7b423          	sd	a0,-88(a5)
    curr_thread->context.sp = (uint64) &curr_thread->ustack[STACK_SIZE];
 9b2:	fa468693          	addi	a3,a3,-92 # fa4 <digits+0x3f4>
 9b6:	9736                	add	a4,a4,a3
 9b8:	fae7b823          	sd	a4,-80(a5)
    curr_thread->ustack[STACK_SIZE - 1] = (uint64) uthread_exit; // Return address to uthread_exit
 9bc:	00000717          	auipc	a4,0x0
 9c0:	edc70713          	addi	a4,a4,-292 # 898 <uthread_exit>
 9c4:	fae781a3          	sb	a4,-93(a5)
    curr_thread->state = RUNNABLE;
 9c8:	4709                	li	a4,2
 9ca:	fae7a223          	sw	a4,-92(a5)
     return 0;
 9ce:	4501                	li	a0,0
}
 9d0:	6422                	ld	s0,8(sp)
 ...
 9d4:	8082                	ret
        return -1;
 9d6:	557d                	li	a0,-1
 9d8:	bfe5                	j	9d0 <uthread_create+0x74>

00000000000009da <uthread_yield>:
    for (int i = curr_thread->id+1; count<MAX_UTHREADS; count++, i=(i+1)%MAX_UTHREADS) {
 9da:	00000517          	auipc	a0,0x0
 9de:	62e53503          	ld	a0,1582(a0) # 1008 <curr_thread>
 9e2:	411c                	lw	a5,0(a0)
 9e4:	2785                	addiw	a5,a5,1
 9e6:	4691                	li	a3,4
    enum sched_priority max_priority = LOW;
 9e8:	4301                	li	t1,0
    struct uthread *next_thread = (struct uthread *) 1;
 9ea:	4585                	li	a1,1
        if (uthreads_arr[i].state == RUNNABLE &&
 9ec:	00000617          	auipc	a2,0x0
 9f0:	6b460613          	addi	a2,a2,1716 # 10a0 <uthreads_arr>
 9f4:	6805                	lui	a6,0x1
 9f6:	4889                	li	a7,2
 9f8:	a819                	j	a0e <uthread_yield+0x34>
    for (int i = curr_thread->id+1; count<MAX_UTHREADS; count++, i=(i+1)%MAX_UTHREADS) {
 9fa:	2785                	addiw	a5,a5,1
 9fc:	41f7d71b          	sraiw	a4,a5,0x1f
 a00:	01e7571b          	srliw	a4,a4,0x1e
 a04:	9fb9                	addw	a5,a5,a4
 a06:	8b8d                	andi	a5,a5,3
 a08:	9f99                	subw	a5,a5,a4
 a0a:	36fd                	addiw	a3,a3,-1
 a0c:	ca9d                	beqz	a3,a42 <uthread_yield+0x68>
        if (uthreads_arr[i].state == RUNNABLE &&
 a0e:	00779713          	slli	a4,a5,0x7
 a12:	973e                	add	a4,a4,a5
 a14:	0716                	slli	a4,a4,0x5
 a16:	9732                	add	a4,a4,a2
 a18:	9742                	add	a4,a4,a6
 a1a:	fa472703          	lw	a4,-92(a4)
 a1e:	fd171ee3          	bne	a4,a7,9fa <uthread_yield+0x20>
            uthreads_arr[i].priority > max_priority) {
 ...
 a2e:	4f18                	lw	a4,24(a4)
        if (uthreads_arr[i].state == RUNNABLE &&
 a30:	fce375e3          	bgeu	t1,a4,9fa <uthread_yield+0x20>
            next_thread = &uthreads_arr[i];
 a34:	00779593          	slli	a1,a5,0x7
 a38:	95be                	add	a1,a1,a5
 a3a:	0596                	slli	a1,a1,0x5
 a3c:	95b2                	add	a1,a1,a2
            max_priority = uthreads_arr[i].priority;
 a3e:	833a                	mv	t1,a4
 a40:	bf6d                	j	9fa <uthread_yield+0x20>
    if (next_thread == (struct uthread *) 1) {
 a42:	4785                	li	a5,1
 a44:	04f58163          	beq	a1,a5,a86 <uthread_yield+0xac>
void uthread_yield() {
 ...
 a4e:	0800                	addi	s0,sp,16
    curr_thread->state = RUNNABLE;
 a50:	6785                	lui	a5,0x1
 a52:	00f50733          	add	a4,a0,a5
 a56:	4689                	li	a3,2
 a58:	fad72223          	sw	a3,-92(a4)
    next_thread->state = RUNNING;
 a5c:	00f58733          	add	a4,a1,a5
 a60:	4685                	li	a3,1
 a62:	fad72223          	sw	a3,-92(a4)
    curr_thread = next_thread;
 a66:	00000717          	auipc	a4,0x0
 a6a:	5ab73123          	sd	a1,1442(a4) # 1008 <curr_thread>
    struct context *next_context = &next_thread->context;
 a6e:	fa878793          	addi	a5,a5,-88 # fa8 <digits+0x3f8>
    uswtch(curr_context, next_context);
 a72:	95be                	add	a1,a1,a5
 a74:	953e                	add	a0,a0,a5
 a76:	00000097          	auipc	ra,0x0
 a7a:	db8080e7          	jalr	-584(ra) # 82e <uswtch>
}
 a7e:	60a2                	ld	ra,8(sp)
 a80:	6402                	ld	s0,0(sp)
...
0000000000000a88 <uthread_set_priority>:
...
enum sched_priority uthread_set_priority(enum sched_priority priority){
 ...
 a92:	57a7b783          	ld	a5,1402(a5) # 1008 <curr_thread>
 a96:	6705                	lui	a4,0x1
 a98:	97ba                	add	a5,a5,a4
 a9a:	4f98                	lw	a4,24(a5)
    curr_thread->priority=priority;
 a9c:	cf88                	sw	a0,24(a5)
    return to_return;
}
 a9e:	853a                	mv	a0,a4
 aa0:	6422                	ld	s0,8(sp)
...
0000000000000aa6 <uthread_get_priority>:
...
enum sched_priority uthread_get_priority(){
 ...
 ab0:	55c7b783          	ld	a5,1372(a5) # 1008 <curr_thread>
 ab4:	6705                	lui	a4,0x1
 ab6:	97ba                	add	a5,a5,a4
}
 ab8:	4f88                	lw	a0,24(a5)
 aba:	6422                	ld	s0,8(sp)
 abc:	0141                	addi	sp,sp,16
 abe:	8082                	ret

0000000000000ac0 <uthread_start_all>:

int uthread_start_all(){
    if (started){
 ac0:	00000797          	auipc	a5,0x0
 ac4:	5507a783          	lw	a5,1360(a5) # 1010 <started>
 ac8:	ebc5                	bnez	a5,b78 <uthread_start_all+0xb8>
int uthread_start_all(){
 ...
 ad8:	52f72e23          	sw	a5,1340(a4) # 1010 <started>
    struct uthread *next_thread = (struct uthread *) 1;
    enum sched_priority max_priority = LOW;
    int count=0;
    for (int i = curr_thread->id+1; count<MAX_UTHREADS;  count++,i=(i+1)%MAX_UTHREADS) {
 adc:	00000797          	auipc	a5,0x0
 ae0:	52c7b783          	ld	a5,1324(a5) # 1008 <curr_thread>
 ae4:	439c                	lw	a5,0(a5)
 ...
 aec:	4605                	li	a2,1
        ...
        if (uthreads_arr[i].state == RUNNABLE &&
 aee:	00000597          	auipc	a1,0x0
 af2:	5b258593          	addi	a1,a1,1458 # 10a0 <uthreads_arr>
 af6:	6505                	lui	a0,0x1
 af8:	4809                	li	a6,2
 afa:	a819                	j	b10 <uthread_start_all+0x50>
    for (int i = curr_thread->id+1; count<MAX_UTHREADS;  count++,i=(i+1)%MAX_UTHREADS) {
 afc:	2785                	addiw	a5,a5,1
 afe:	41f7d71b          	sraiw	a4,a5,0x1f
 b02:	01e7571b          	srliw	a4,a4,0x1e
 b06:	9fb9                	addw	a5,a5,a4
 b08:	8b8d                	andi	a5,a5,3
 b0a:	9f99                	subw	a5,a5,a4
 b0c:	36fd                	addiw	a3,a3,-1
 b0e:	ca9d                	beqz	a3,b44 <uthread_start_all+0x84>
        if (uthreads_arr[i].state == RUNNABLE &&
 b10:	00779713          	slli	a4,a5,0x7
 b14:	973e                	add	a4,a4,a5
 b16:	0716                	slli	a4,a4,0x5
 b18:	972e                	add	a4,a4,a1
 b1a:	972a                	add	a4,a4,a0
 b1c:	fa472703          	lw	a4,-92(a4)
 b20:	fd071ee3          	bne	a4,a6,afc <uthread_start_all+0x3c>
            uthreads_arr[i].priority > max_priority) {
 ...
 b30:	4f18                	lw	a4,24(a4)
        if (uthreads_arr[i].state == RUNNABLE &&
 b32:	fce8f5e3          	bgeu	a7,a4,afc <uthread_start_all+0x3c>
            next_thread = &uthreads_arr[i];
 b36:	00779613          	slli	a2,a5,0x7
 b3a:	963e                	add	a2,a2,a5
 b3c:	0616                	slli	a2,a2,0x5
 b3e:	962e                	add	a2,a2,a1
            max_priority = uthreads_arr[i].priority;
 b40:	88ba                	mv	a7,a4
 b42:	bf6d                	j	afc <uthread_start_all+0x3c>
        }
    }
    struct context *next_context = &next_thread->context;
    next_thread->state = RUNNING;
 b44:	6585                	lui	a1,0x1
 b46:	00b607b3          	add	a5,a2,a1
 b4a:	4705                	li	a4,1
 b4c:	fae7a223          	sw	a4,-92(a5)
    curr_thread = next_thread;
 b50:	00000797          	auipc	a5,0x0
 b54:	4ac7bc23          	sd	a2,1208(a5) # 1008 <curr_thread>
    struct context *next_context = &next_thread->context;
 b58:	fa858593          	addi	a1,a1,-88 # fa8 <digits+0x3f8>
    uswtch(&garbageContext,next_context);
 b5c:	95b2                	add	a1,a1,a2
 b5e:	00000517          	auipc	a0,0x0
 b62:	4d250513          	addi	a0,a0,1234 # 1030 <garbageContext>
 b66:	00000097          	auipc	ra,0x0
 b6a:	cc8080e7          	jalr	-824(ra) # 82e <uswtch>
...
struct uthread* uthread_self(){
 ...
 b86:	48653503          	ld	a0,1158(a0) # 1008 <curr_thread>
 b8a:	6422                	ld	s0,8(sp)
