...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	2d250513          	addi	a0,a0,722 # 6310 <uthread_yield+0x116>
      ...
      74:	8082                	ret
{
      ...
      84:	2b050513          	addi	a0,a0,688 # 6330 <uthread_yield+0x136>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	2a050513          	addi	a0,a0,672 # 6348 <uthread_yield+0x14e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	2a250513          	addi	a0,a0,674 # 6368 <uthread_yield+0x16e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	26a50513          	addi	a0,a0,618 # 6350 <uthread_yield+0x156>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	27650513          	addi	a0,a0,630 # 6378 <uthread_yield+0x17e>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	27450513          	addi	a0,a0,628 # 63a0 <uthread_yield+0x1a6>
     134:	00006097          	auipc	ra,0x6
     138:	ae2080e7          	jalr	-1310(ra) # 5c16 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	26050513          	addi	a0,a0,608 # 63a0 <uthread_yield+0x1a6>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	25c58593          	addi	a1,a1,604 # 63b0 <uthread_yield+0x1b6>
     15c:	00006097          	auipc	ra,0x6
     160:	a8a080e7          	jalr	-1398(ra) # 5be6 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	23850513          	addi	a0,a0,568 # 63a0 <uthread_yield+0x1a6>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	23c58593          	addi	a1,a1,572 # 63b8 <uthread_yield+0x1be>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	20c50513          	addi	a0,a0,524 # 63a0 <uthread_yield+0x1a6>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	1f650513          	addi	a0,a0,502 # 63c0 <uthread_yield+0x1c6>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	16c50513          	addi	a0,a0,364 # 63e8 <uthread_yield+0x1ee>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	158a8a93          	addi	s5,s5,344 # 63e8 <uthread_yield+0x1ee>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	0e650513          	addi	a0,a0,230 # 63f8 <uthread_yield+0x1fe>
     ...
     33a:	0e250513          	addi	a0,a0,226 # 6418 <uthread_yield+0x21e>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	0d050513          	addi	a0,a0,208 # 6430 <uthread_yield+0x236>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	0bc98993          	addi	s3,s3,188 # 6430 <uthread_yield+0x236>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	07050513          	addi	a0,a0,112 # 6430 <uthread_yield+0x236>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	fe058593          	addi	a1,a1,-32 # 63b8 <uthread_yield+0x1be>
    ...
    printf("write failed\n");
     ...
     3f2:	06250513          	addi	a0,a0,98 # 6450 <uthread_yield+0x256>
    ...
    exit(1);
     ...
     40c:	03050513          	addi	a0,a0,48 # 6438 <uthread_yield+0x23e>
    ...
    printf("open junk failed\n");
     ...
     426:	01650513          	addi	a0,a0,22 # 6438 <uthread_yield+0x23e>
  ...
  unlink("junk");
     ...
     44a:	fea50513          	addi	a0,a0,-22 # 6430 <uthread_yield+0x236>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	f0ea0a13          	addi	s4,s4,-242 # 6460 <uthread_yield+0x266>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	e6a50513          	addi	a0,a0,-406 # 6468 <uthread_yield+0x26e>
     ...
     620:	e6450513          	addi	a0,a0,-412 # 6480 <uthread_yield+0x286>
     ...
     63e:	e7650513          	addi	a0,a0,-394 # 64b0 <uthread_yield+0x2b6>
     ...
     658:	e8c50513          	addi	a0,a0,-372 # 64e0 <uthread_yield+0x2e6>
     ...
     676:	e7e50513          	addi	a0,a0,-386 # 64f0 <uthread_yield+0x2f6>
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	e70a0a13          	addi	s4,s4,-400 # 6520 <uthread_yield+0x326>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	d00a8a93          	addi	s5,s5,-768 # 63b8 <uthread_yield+0x1be>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	dca50513          	addi	a0,a0,-566 # 6528 <uthread_yield+0x32e>
     ...
     780:	dc450513          	addi	a0,a0,-572 # 6540 <uthread_yield+0x346>
     ...
     79a:	d4a50513          	addi	a0,a0,-694 # 64e0 <uthread_yield+0x2e6>
     ...
     7b4:	dc050513          	addi	a0,a0,-576 # 6570 <uthread_yield+0x376>
     ...
     7d2:	dba50513          	addi	a0,a0,-582 # 6588 <uthread_yield+0x38e>
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	b8c58593          	addi	a1,a1,-1140 # 63b0 <uthread_yield+0x1b6>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	b6050513          	addi	a0,a0,-1184 # 63a0 <uthread_yield+0x1a6>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	b3450513          	addi	a0,a0,-1228 # 63a0 <uthread_yield+0x1a6>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	b2050513          	addi	a0,a0,-1248 # 63a0 <uthread_yield+0x1a6>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	d5a58593          	addi	a1,a1,-678 # 6618 <uthread_yield+0x41e>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	aa050513          	addi	a0,a0,-1376 # 63a0 <uthread_yield+0x1a6>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	c7450513          	addi	a0,a0,-908 # 65b8 <uthread_yield+0x3be>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	c7850513          	addi	a0,a0,-904 # 65d8 <uthread_yield+0x3de>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     978:	c7450513          	addi	a0,a0,-908 # 65e8 <uthread_yield+0x3ee>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	c7850513          	addi	a0,a0,-904 # 6608 <uthread_yield+0x40e>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a8:	c4450513          	addi	a0,a0,-956 # 65e8 <uthread_yield+0x3ee>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	c5e50513          	addi	a0,a0,-930 # 6620 <uthread_yield+0x426>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	c6050513          	addi	a0,a0,-928 # 6640 <uthread_yield+0x446>
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	c4c50513          	addi	a0,a0,-948 # 6660 <uthread_yield+0x466>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	c5c98993          	addi	s3,s3,-932 # 6688 <uthread_yield+0x48e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	c8ca8a93          	addi	s5,s5,-884 # 66c0 <uthread_yield+0x4c6>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	be650513          	addi	a0,a0,-1050 # 6660 <uthread_yield+0x466>
  ...
  if(unlink("small") < 0){
     ...
     aba:	baa50513          	addi	a0,a0,-1110 # 6660 <uthread_yield+0x466>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	b8850513          	addi	a0,a0,-1144 # 6668 <uthread_yield+0x46e>
    ...
    exit(1);
     ...
     b02:	b9a50513          	addi	a0,a0,-1126 # 6698 <uthread_yield+0x49e>
     ...
     b20:	bb450513          	addi	a0,a0,-1100 # 66d0 <uthread_yield+0x4d6>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	bc050513          	addi	a0,a0,-1088 # 66f8 <uthread_yield+0x4fe>
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	bc450513          	addi	a0,a0,-1084 # 6718 <uthread_yield+0x51e>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	bc050513          	addi	a0,a0,-1088 # 6730 <uthread_yield+0x536>
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	bae50513          	addi	a0,a0,-1106 # 6750 <uthread_yield+0x556>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	b5c50513          	addi	a0,a0,-1188 # 6750 <uthread_yield+0x556>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	b1c50513          	addi	a0,a0,-1252 # 6758 <uthread_yield+0x55e>
    ...
    exit(1);
     ...
     c5e:	b1e50513          	addi	a0,a0,-1250 # 6778 <uthread_yield+0x57e>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	b2a50513          	addi	a0,a0,-1238 # 67a0 <uthread_yield+0x5a6>
  ...
  if(unlink("big") < 0){
     ...
     ca6:	aae50513          	addi	a0,a0,-1362 # 6750 <uthread_yield+0x556>
     ...
     cd2:	af250513          	addi	a0,a0,-1294 # 67c0 <uthread_yield+0x5c6>
     ...
     cf0:	afc50513          	addi	a0,a0,-1284 # 67e8 <uthread_yield+0x5ee>
     ...
     d0e:	af650513          	addi	a0,a0,-1290 # 6800 <uthread_yield+0x606>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	b0250513          	addi	a0,a0,-1278 # 6828 <uthread_yield+0x62e>
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	aec50513          	addi	a0,a0,-1300 # 6840 <uthread_yield+0x646>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	b0458593          	addi	a1,a1,-1276 # 6870 <uthread_yield+0x676>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	ab850513          	addi	a0,a0,-1352 # 6840 <uthread_yield+0x646>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	aa250513          	addi	a0,a0,-1374 # 6840 <uthread_yield+0x646>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	a8c50513          	addi	a0,a0,-1396 # 6840 <uthread_yield+0x646>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	af058593          	addi	a1,a1,-1296 # 68b8 <uthread_yield+0x6be>
  ...
  unlink("unlinkread");
     ...
     e34:	a1050513          	addi	a0,a0,-1520 # 6840 <uthread_yield+0x646>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	a0050513          	addi	a0,a0,-1536 # 6850 <uthread_yield+0x656>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	a0c50513          	addi	a0,a0,-1524 # 6878 <uthread_yield+0x67e>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	a1050513          	addi	a0,a0,-1520 # 6898 <uthread_yield+0x69e>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	a1c50513          	addi	a0,a0,-1508 # 68c0 <uthread_yield+0x6c6>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	a2050513          	addi	a0,a0,-1504 # 68e0 <uthread_yield+0x6e6>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	a2450513          	addi	a0,a0,-1500 # 6900 <uthread_yield+0x706>
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	93058593          	addi	a1,a1,-1744 # 6870 <uthread_yield+0x676>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	9c858593          	addi	a1,a1,-1592 # 6928 <uthread_yield+0x72e>
     f68:	00006517          	auipc	a0,0x6
     f6c:	9b850513          	addi	a0,a0,-1608 # 6920 <uthread_yield+0x726>
  ...
  unlink("lf1");
     ...
     f80:	9a450513          	addi	a0,a0,-1628 # 6920 <uthread_yield+0x726>
     f84:	00005097          	auipc	ra,0x5
     f88:	c92080e7          	jalr	-878(ra) # 5c16 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00006517          	auipc	a0,0x6
     f92:	99250513          	addi	a0,a0,-1646 # 6920 <uthread_yield+0x726>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	98450513          	addi	a0,a0,-1660 # 6928 <uthread_yield+0x72e>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	94c58593          	addi	a1,a1,-1716 # 6928 <uthread_yield+0x72e>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	93650513          	addi	a0,a0,-1738 # 6928 <uthread_yield+0x72e>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c1c080e7          	jalr	-996(ra) # 5c16 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00006597          	auipc	a1,0x6
    1006:	91e58593          	addi	a1,a1,-1762 # 6920 <uthread_yield+0x726>
    100a:	00006517          	auipc	a0,0x6
    100e:	91e50513          	addi	a0,a0,-1762 # 6928 <uthread_yield+0x72e>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	90258593          	addi	a1,a1,-1790 # 6920 <uthread_yield+0x726>
    1026:	00006517          	auipc	a0,0x6
    102a:	a0a50513          	addi	a0,a0,-1526 # 6a30 <uthread_yield+0x836>
    ...
    104c:	8e850513          	addi	a0,a0,-1816 # 6930 <uthread_yield+0x736>
    ...
    1068:	8e450513          	addi	a0,a0,-1820 # 6948 <uthread_yield+0x74e>
    ...
    1084:	8e050513          	addi	a0,a0,-1824 # 6960 <uthread_yield+0x766>
    ...
    10a0:	8e450513          	addi	a0,a0,-1820 # 6980 <uthread_yield+0x786>
    ...
    10bc:	8f850513          	addi	a0,a0,-1800 # 69b0 <uthread_yield+0x7b6>
    ...
    10d8:	8f450513          	addi	a0,a0,-1804 # 69c8 <uthread_yield+0x7ce>
    ...
    10f4:	8f050513          	addi	a0,a0,-1808 # 69e0 <uthread_yield+0x7e6>
    ...
    1110:	8fc50513          	addi	a0,a0,-1796 # 6a08 <uthread_yield+0x80e>
    ...
    112c:	91050513          	addi	a0,a0,-1776 # 6a38 <uthread_yield+0x83e>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	8fe98993          	addi	s3,s3,-1794 # 6a58 <uthread_yield+0x85e>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	8d250513          	addi	a0,a0,-1838 # 6a68 <uthread_yield+0x86e>
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	88ca0a13          	addi	s4,s4,-1908 # 6a88 <uthread_yield+0x88e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	83a50513          	addi	a0,a0,-1990 # 6a88 <uthread_yield+0x88e>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	7d250513          	addi	a0,a0,2002 # 6a90 <uthread_yield+0x896>
    ...
    12e2:	7d250513          	addi	a0,a0,2002 # 6ab0 <uthread_yield+0x8b6>
    ...
    12fe:	7d650513          	addi	a0,a0,2006 # 6ad0 <uthread_yield+0x8d6>
...
000000000000134c <badarg>:
{
    ...
    136a:	fe298993          	addi	s3,s3,-30 # 6348 <uthread_yield+0x14e>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	93878793          	addi	a5,a5,-1736 # 7d28 <uthread_yield+0x1b2e>
  ...
  if(pid == 0){
    ...
    1450:	2fc78793          	addi	a5,a5,764 # 8748 <uthread_yield+0x254e>
    ...
    1474:	ed850513          	addi	a0,a0,-296 # 6348 <uthread_yield+0x14e>
    ...
    148c:	6f050513          	addi	a0,a0,1776 # 6b78 <uthread_yield+0x97e>
    ...
    14ac:	64850513          	addi	a0,a0,1608 # 6af0 <uthread_yield+0x8f6>
    ...
    14cc:	64850513          	addi	a0,a0,1608 # 6b10 <uthread_yield+0x916>
    ...
    14ee:	64650513          	addi	a0,a0,1606 # 6b30 <uthread_yield+0x936>
    ...
    150e:	64e50513          	addi	a0,a0,1614 # 6b58 <uthread_yield+0x95e>
    ...
    1528:	ab450513          	addi	a0,a0,-1356 # 6fd8 <uthread_yield+0xdde>
  ...
  if(st != 747){
    ...
    1572:	63250513          	addi	a0,a0,1586 # 6ba0 <uthread_yield+0x9a6>
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	e0050513          	addi	a0,a0,-512 # 63a0 <uthread_yield+0x1a6>
  ...
  if(pid == 0){
    ...
    15ce:	dd6a0a13          	addi	s4,s4,-554 # 63a0 <uthread_yield+0x1a6>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	62ea8a93          	addi	s5,s5,1582 # 6c00 <uthread_yield+0xa06>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	58e50513          	addi	a0,a0,1422 # 6bd0 <uthread_yield+0x9d6>
    ...
    1662:	58a50513          	addi	a0,a0,1418 # 6be8 <uthread_yield+0x9ee>
    ...
    1680:	59450513          	addi	a0,a0,1428 # 6c10 <uthread_yield+0xa16>
    ...
    169e:	d06a0a13          	addi	s4,s4,-762 # 63a0 <uthread_yield+0x1a6>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	58ea8a93          	addi	s5,s5,1422 # 6c30 <uthread_yield+0xa36>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	cb450513          	addi	a0,a0,-844 # 63a0 <uthread_yield+0x1a6>
  ...
  exit(xstatus);
    ...
    170e:	4de50513          	addi	a0,a0,1246 # 6be8 <uthread_yield+0x9ee>
    ...
    172c:	51050513          	addi	a0,a0,1296 # 6c38 <uthread_yield+0xa3e>
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	bf878793          	addi	a5,a5,-1032 # 6348 <uthread_yield+0x14e>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	4fc78793          	addi	a5,a5,1276 # 6c58 <uthread_yield+0xa5e>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	4f450513          	addi	a0,a0,1268 # 6c60 <uthread_yield+0xa66>
  ...
  if(pid == 0) {
    ...
    179e:	4c650513          	addi	a0,a0,1222 # 6c60 <uthread_yield+0xa66>
    ...
    17ba:	4ca50513          	addi	a0,a0,1226 # 6c80 <uthread_yield+0xa86>
    ...
    17d6:	3fe50513          	addi	a0,a0,1022 # 6bd0 <uthread_yield+0x9d6>
    ...
    17f2:	47a50513          	addi	a0,a0,1146 # 6c68 <uthread_yield+0xa6e>
    ...
    1810:	b3c50513          	addi	a0,a0,-1220 # 6348 <uthread_yield+0x14e>
  ...
  if(xstatus != 0)
    ...
    1844:	45050513          	addi	a0,a0,1104 # 6c90 <uthread_yield+0xa96>
    ...
    1860:	44c50513          	addi	a0,a0,1100 # 6ca8 <uthread_yield+0xaae>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1874:	3f050513          	addi	a0,a0,1008 # 6c60 <uthread_yield+0xa66>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	e7e50513          	addi	a0,a0,-386 # 6718 <uthread_yield+0x51e>
    ...
    18ba:	33250513          	addi	a0,a0,818 # 6be8 <uthread_yield+0x9ee>
  ...
  unlink("echo-ok");
    ...
    18d4:	39050513          	addi	a0,a0,912 # 6c60 <uthread_yield+0xa66>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	3c650513          	addi	a0,a0,966 # 6cc0 <uthread_yield+0xac6>
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c0:	31c50513          	addi	a0,a0,796 # 6cd8 <uthread_yield+0xade>
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a46:	2ae50513          	addi	a0,a0,686 # 6cf0 <uthread_yield+0xaf6>
    ...
    1a62:	2aa50513          	addi	a0,a0,682 # 6d08 <uthread_yield+0xb0e>
    ...
    1a94:	29050513          	addi	a0,a0,656 # 6d20 <uthread_yield+0xb26>
    ...
    1ad4:	27050513          	addi	a0,a0,624 # 6d40 <uthread_yield+0xb46>
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	08e50513          	addi	a0,a0,142 # 6bd0 <uthread_yield+0x9d6>
    ...
    1b62:	1fa50513          	addi	a0,a0,506 # 6d58 <uthread_yield+0xb5e>
    ...
    1b7e:	1f650513          	addi	a0,a0,502 # 6d70 <uthread_yield+0xb76>
...
0000000000001b9e <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	fde50513          	addi	a0,a0,-34 # 6bd0 <uthread_yield+0x9d6>
    ...
    1c1a:	fba50513          	addi	a0,a0,-70 # 6bd0 <uthread_yield+0x9d6>
...
0000000000001c38 <forkfork>:
{
    ...
    1c94:	10050513          	addi	a0,a0,256 # 6d90 <uthread_yield+0xb96>
    ...
    1ca6:	f24080e7          	jalr	-220(ra) # 5bc6 <exit>
{
    ...
    1cec:	0b850513          	addi	a0,a0,184 # 6da0 <uthread_yield+0xba6>
...
0000000000001d02 <reparent2>:
{
  ...
  exit(0);
    ...
    1d3a:	2a250513          	addi	a0,a0,674 # 6fd8 <uthread_yield+0xdde>
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	20450513          	addi	a0,a0,516 # 6fd8 <uthread_yield+0xdde>
    ...
    1e04:	e6850513          	addi	a0,a0,-408 # 6c68 <uthread_yield+0xa6e>
    ...
    1e76:	f4e50513          	addi	a0,a0,-178 # 6dc0 <uthread_yield+0xbc6>
    ...
    1eaa:	f3250513          	addi	a0,a0,-206 # 6dd8 <uthread_yield+0xbde>
    ...
    1f10:	ef450513          	addi	a0,a0,-268 # 6e00 <uthread_yield+0xc06>
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	40c50513          	addi	a0,a0,1036 # 63b8 <uthread_yield+0x1be>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	3d0a8a93          	addi	s5,s5,976 # 63b8 <uthread_yield+0x1be>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	e38b8b93          	addi	s7,s7,-456 # 6e28 <uthread_yield+0xc2e>
    1ff8:	a825                	j	2030 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	bd450513          	addi	a0,a0,-1068 # 6bd0 <uthread_yield+0x9d6>
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	d8a50513          	addi	a0,a0,-630 # 6e48 <uthread_yield+0xc4e>
  ...
  if(wait(0) != -1){
    ...
    2124:	d1050513          	addi	a0,a0,-752 # 6e30 <uthread_yield+0xc36>
    ...
    2140:	d3450513          	addi	a0,a0,-716 # 6e70 <uthread_yield+0xc76>
    ...
    215c:	d3050513          	addi	a0,a0,-720 # 6e88 <uthread_yield+0xc8e>
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2198:	48090913          	addi	s2,s2,1152 # 1003d480 <uthreads_arr+0x1002d7e8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	9f850513          	addi	a0,a0,-1544 # 6bd0 <uthread_yield+0x9d6>
    ...
    21fe:	ca650513          	addi	a0,a0,-858 # 6ea0 <uthread_yield+0xca6>
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	95450513          	addi	a0,a0,-1708 # 6bd0 <uthread_yield+0x9d6>
    ...
    22ac:	c1850513          	addi	a0,a0,-1000 # 6ec0 <uthread_yield+0xcc6>
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	c0050513          	addi	a0,a0,-1024 # 6ed8 <uthread_yield+0xcde>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	bce50513          	addi	a0,a0,-1074 # 6ed8 <uthread_yield+0xcde>
  ...
  close(fd);
    ...
    2344:	ba870713          	addi	a4,a4,-1112 # 6ee8 <uthread_yield+0xcee>
    ...
    2398:	c3450513          	addi	a0,a0,-972 # 6fc8 <uthread_yield+0xdce>
    ...
    23bc:	c3050513          	addi	a0,a0,-976 # 6fe8 <uthread_yield+0xdee>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2410:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <uthreads_arr+0xfffffffffffef368>
    2414:	85a6                	mv	a1,s1
    2416:	00005517          	auipc	a0,0x5
    241a:	bf250513          	addi	a0,a0,-1038 # 7008 <uthread_yield+0xe0e>
    ...
    2436:	79e50513          	addi	a0,a0,1950 # 6bd0 <uthread_yield+0x9d6>
...
0000000000002456 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a4:	73050513          	addi	a0,a0,1840 # 6bd0 <uthread_yield+0x9d6>
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2520:	abc50513          	addi	a0,a0,-1348 # 6fd8 <uthread_yield+0xdde>
    ...
    25d0:	a6450513          	addi	a0,a0,-1436 # 7030 <uthread_yield+0xe36>
    ...
    25f0:	e2c50513          	addi	a0,a0,-468 # 6418 <uthread_yield+0x21e>
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2688:	6a478793          	addi	a5,a5,1700 # 7d28 <uthread_yield+0x1b2e>
  ...
  if(ret != -1){
    ...
    26ca:	98250513          	addi	a0,a0,-1662 # 7048 <uthread_yield+0xe4e>
    ...
    26e8:	40c50513          	addi	a0,a0,1036 # 6af0 <uthread_yield+0x8f6>
    ...
    2706:	40e50513          	addi	a0,a0,1038 # 6b10 <uthread_yield+0x916>
    ...
    2726:	40e50513          	addi	a0,a0,1038 # 6b30 <uthread_yield+0x936>
    ...
    2744:	41850513          	addi	a0,a0,1048 # 6b58 <uthread_yield+0x95e>
...
000000000000275a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2790:	8fc50513          	addi	a0,a0,-1796 # 7088 <uthread_yield+0xe8e>
  ...
  if(n >= 0){
    ...
    27c2:	8ea50513          	addi	a0,a0,-1814 # 70a8 <uthread_yield+0xeae>
    ...
    27dc:	87850513          	addi	a0,a0,-1928 # 7050 <uthread_yield+0xe56>
    ...
    27f6:	87650513          	addi	a0,a0,-1930 # 7068 <uthread_yield+0xe6e>
    ...
    2810:	88450513          	addi	a0,a0,-1916 # 7090 <uthread_yield+0xe96>
  ...
  unlink("rwsbrk");
    ...
    2834:	85850513          	addi	a0,a0,-1960 # 7088 <uthread_yield+0xe8e>
    2838:	00003097          	auipc	ra,0x3
    283c:	3de080e7          	jalr	990(ra) # 5c16 <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	cde50513          	addi	a0,a0,-802 # 6520 <uthread_yield+0x326>
  ...
  if(n >= 0){
    ...
    2870:	86c50513          	addi	a0,a0,-1940 # 70d8 <uthread_yield+0xede>
    ...
    288a:	80a50513          	addi	a0,a0,-2038 # 7090 <uthread_yield+0xe96>
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    28f0:	6705                	lui	a4,0x1
      *b = 99;
    28f2:	00d50023          	sb	a3,0(a0) # 40000000 <uthreads_arr+0x3fff0368>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    290a:	7fa50513          	addi	a0,a0,2042 # 7100 <uthread_yield+0xf06>
  ...
  for(i = 0; i < 5000; i++){
    ...
    295c:	7c850513          	addi	a0,a0,1992 # 7120 <uthread_yield+0xf26>
  ...
  if(c != a + 1){
    ...
    29c0:	7c450513          	addi	a0,a0,1988 # 7180 <uthread_yield+0xf86>
    ...
    29e2:	76250513          	addi	a0,a0,1890 # 7140 <uthread_yield+0xf46>
    ...
    29fe:	76650513          	addi	a0,a0,1894 # 7160 <uthread_yield+0xf66>
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2a9c:	fee78fa3          	sb	a4,-1(a5) # 63fffff <uthreads_arr+0x63f0367>
  a = sbrk(0);
    2aa0:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2b00:	fff7c703          	lbu	a4,-1(a5) # 63fffff <uthreads_arr+0x63f0367>
  ...
  if(c != a){
    ...
    2b48:	65c50513          	addi	a0,a0,1628 # 71a0 <uthread_yield+0xfa6>
    ...
    2b64:	68850513          	addi	a0,a0,1672 # 71e8 <uthread_yield+0xfee>
    ...
    2b84:	68850513          	addi	a0,a0,1672 # 7208 <uthread_yield+0x100e>
    ...
    2ba4:	6a850513          	addi	a0,a0,1704 # 7248 <uthread_yield+0x104e>
    ...
    2bc0:	6bc50513          	addi	a0,a0,1724 # 7278 <uthread_yield+0x107e>
    ...
    2be0:	6d450513          	addi	a0,a0,1748 # 72b0 <uthread_yield+0x10b6>
...
0000000000002bf6 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c1a:	6c250513          	addi	a0,a0,1730 # 72d8 <uthread_yield+0x10de>
    2c1e:	00003097          	auipc	ra,0x3
    2c22:	fe8080e7          	jalr	-24(ra) # 5c06 <open>
    2c26:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c28:	00004517          	auipc	a0,0x4
    2c2c:	6b050513          	addi	a0,a0,1712 # 72d8 <uthread_yield+0x10de>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c80:	66450513          	addi	a0,a0,1636 # 72e0 <uthread_yield+0x10e6>
    ...
    2c9c:	66050513          	addi	a0,a0,1632 # 72f8 <uthread_yield+0x10fe>
    ...
    2cb8:	02450513          	addi	a0,a0,36 # 6cd8 <uthread_yield+0xade>
...
0000000000002cce <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce2:	63250513          	addi	a0,a0,1586 # 7310 <uthread_yield+0x1116>
  ...
  close(fd);
    ...
    2d2a:	ec250513          	addi	a0,a0,-318 # 6be8 <uthread_yield+0x9ee>
...
0000000000002d40 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d78:	26450513          	addi	a0,a0,612 # 6fd8 <uthread_yield+0xdde>
  ...
  if(pid == 0){
    ...
    2dce:	20e50513          	addi	a0,a0,526 # 6fd8 <uthread_yield+0xdde>
  ...
  if(pid == 0){
    ...
    2e2e:	1ae50513          	addi	a0,a0,430 # 6fd8 <uthread_yield+0xdde>
...
0000000000002f2a <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2f4a:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <uthreads_arr+0xffffffff7fff0367>
...
0000000000002f60 <execout>:
{
  ...
  exit(0);
    ...
    2fa2:	03a50513          	addi	a0,a0,58 # 6fd8 <uthread_yield+0xdde>
    ...
    2ff6:	35650513          	addi	a0,a0,854 # 6348 <uthread_yield+0x14e>
    2ffa:	faa43c23          	sd	a0,-72(s0)
    2ffe:	00003797          	auipc	a5,0x3
    3002:	3ba78793          	addi	a5,a5,954 # 63b8 <uthread_yield+0x1be>
...
0000000000003024 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3034:	4b850513          	addi	a0,a0,1208 # 74e8 <uthread_yield+0x12ee>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3046:	2fe50513          	addi	a0,a0,766 # 7340 <uthread_yield+0x1146>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    305c:	34050513          	addi	a0,a0,832 # 7398 <uthread_yield+0x119e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    307a:	39a50513          	addi	a0,a0,922 # 7410 <uthread_yield+0x1216>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3096:	3ee50513          	addi	a0,a0,1006 # 7480 <uthread_yield+0x1286>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a8:	43450513          	addi	a0,a0,1076 # 74d8 <uthread_yield+0x12de>
  ...
  unlink("12345678901234");
    ...
    3126:	1f650513          	addi	a0,a0,502 # 7318 <uthread_yield+0x111e>
    ...
    3142:	22250513          	addi	a0,a0,546 # 7360 <uthread_yield+0x1166>
    ...
    315e:	26e50513          	addi	a0,a0,622 # 73c8 <uthread_yield+0x11ce>
    ...
    317a:	2ca50513          	addi	a0,a0,714 # 7440 <uthread_yield+0x1246>
    ...
    3196:	30e50513          	addi	a0,a0,782 # 74a0 <uthread_yield+0x12a6>
    ...
    31b2:	34a50513          	addi	a0,a0,842 # 74f8 <uthread_yield+0x12fe>
...
00000000000031c8 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fe:	33650513          	addi	a0,a0,822 # 7530 <uthread_yield+0x1336>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3228:	31c50513          	addi	a0,a0,796 # 7540 <uthread_yield+0x1346>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b8:	27c50513          	addi	a0,a0,636 # 7530 <uthread_yield+0x1336>
  ...
  unlink("diskfulldir");
    ...
    32cc:	26850513          	addi	a0,a0,616 # 7530 <uthread_yield+0x1336>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33fa:	16a50513          	addi	a0,a0,362 # 7560 <uthread_yield+0x1366>
...
0000000000003408 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3418:	17c50513          	addi	a0,a0,380 # 7590 <uthread_yield+0x1396>
  ...
  if(chdir("iputdir") < 0){
    ...
    342c:	16850513          	addi	a0,a0,360 # 7590 <uthread_yield+0x1396>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3440:	19450513          	addi	a0,a0,404 # 75d0 <uthread_yield+0x13d6>
  ...
  if(chdir("/") < 0){
    ...
    3454:	1b050513          	addi	a0,a0,432 # 7600 <uthread_yield+0x1406>
    ...
    3474:	12850513          	addi	a0,a0,296 # 7598 <uthread_yield+0x139e>
    ...
    3490:	12450513          	addi	a0,a0,292 # 75b0 <uthread_yield+0x13b6>
    ...
    34ac:	13850513          	addi	a0,a0,312 # 75e0 <uthread_yield+0x13e6>
    ...
    34c8:	14450513          	addi	a0,a0,324 # 7608 <uthread_yield+0x140e>
...
00000000000034de <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fc:	09850513          	addi	a0,a0,152 # 7590 <uthread_yield+0x1396>
    ...
    3510:	08450513          	addi	a0,a0,132 # 7590 <uthread_yield+0x1396>
    ...
    3524:	0b050513          	addi	a0,a0,176 # 75d0 <uthread_yield+0x13d6>
    ...
    3544:	69050513          	addi	a0,a0,1680 # 6bd0 <uthread_yield+0x9d6>
    ...
    3560:	03c50513          	addi	a0,a0,60 # 7598 <uthread_yield+0x139e>
    ...
    357c:	0a850513          	addi	a0,a0,168 # 7620 <uthread_yield+0x1426>
    ...
    3598:	04c50513          	addi	a0,a0,76 # 75e0 <uthread_yield+0x13e6>
...
00000000000035c6 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d6:	06650513          	addi	a0,a0,102 # 7638 <uthread_yield+0x143e>
  ...
  if(chdir("dir0") < 0){
    ...
    35ea:	05250513          	addi	a0,a0,82 # 7638 <uthread_yield+0x143e>
  ...
  if(chdir("..") < 0){
    ...
    35fe:	05e50513          	addi	a0,a0,94 # 7658 <uthread_yield+0x145e>
  ...
  if(unlink("dir0") < 0){
    ...
    3612:	02a50513          	addi	a0,a0,42 # 7638 <uthread_yield+0x143e>
    ...
    3632:	f6a50513          	addi	a0,a0,-150 # 7598 <uthread_yield+0x139e>
    ...
    364e:	ff650513          	addi	a0,a0,-10 # 7640 <uthread_yield+0x1446>
    ...
    366a:	ffa50513          	addi	a0,a0,-6 # 7660 <uthread_yield+0x1466>
    ...
    3686:	ff650513          	addi	a0,a0,-10 # 7678 <uthread_yield+0x147e>
...
000000000000369c <subdir>:
{
  ...
  unlink("ff");
    ...
    36ae:	11650513          	addi	a0,a0,278 # 77c0 <uthread_yield+0x15c6>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	564080e7          	jalr	1380(ra) # 5c16 <unlink>
  if(mkdir("dd") != 0){
    36ba:	00004517          	auipc	a0,0x4
    36be:	fd650513          	addi	a0,a0,-42 # 7690 <uthread_yield+0x1496>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d6:	fde50513          	addi	a0,a0,-34 # 76b0 <uthread_yield+0x14b6>
  ...
  write(fd, "ff", 2);
    ...
    36ee:	0d658593          	addi	a1,a1,214 # 77c0 <uthread_yield+0x15c6>
  ...
  if(unlink("dd") >= 0){
    ...
    3708:	f8c50513          	addi	a0,a0,-116 # 7690 <uthread_yield+0x1496>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371c:	ff050513          	addi	a0,a0,-16 # 7708 <uthread_yield+0x150e>
  ...
  write(fd, "FF", 2);
    ...
    374c:	01858593          	addi	a1,a1,24 # 7760 <uthread_yield+0x1566>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3768:	00450513          	addi	a0,a0,4 # 7768 <uthread_yield+0x156e>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37b0:	00c58593          	addi	a1,a1,12 # 77b8 <uthread_yield+0x15be>
    37b4:	00004517          	auipc	a0,0x4
    37b8:	f7c50513          	addi	a0,a0,-132 # 7730 <uthread_yield+0x1536>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37cc:	f6850513          	addi	a0,a0,-152 # 7730 <uthread_yield+0x1536>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e2:	f5250513          	addi	a0,a0,-174 # 7730 <uthread_yield+0x1536>
  ...
  if(chdir("dd") != 0){
    ...
    37f6:	e9e50513          	addi	a0,a0,-354 # 7690 <uthread_yield+0x1496>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380a:	04a50513          	addi	a0,a0,74 # 7850 <uthread_yield+0x1656>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    381e:	06650513          	addi	a0,a0,102 # 7880 <uthread_yield+0x1686>
  ...
  if(chdir("./..") != 0){
    ...
    3832:	08250513          	addi	a0,a0,130 # 78b0 <uthread_yield+0x16b6>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3848:	f7450513          	addi	a0,a0,-140 # 77b8 <uthread_yield+0x15be>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3882:	eb250513          	addi	a0,a0,-334 # 7730 <uthread_yield+0x1536>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389a:	0aa50513          	addi	a0,a0,170 # 7940 <uthread_yield+0x1746>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b2:	0c250513          	addi	a0,a0,194 # 7970 <uthread_yield+0x1776>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38ca:	dca50513          	addi	a0,a0,-566 # 7690 <uthread_yield+0x1496>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e0:	db450513          	addi	a0,a0,-588 # 7690 <uthread_yield+0x1496>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f6:	d9e50513          	addi	a0,a0,-610 # 7690 <uthread_yield+0x1496>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    390a:	0fa58593          	addi	a1,a1,250 # 7a00 <uthread_yield+0x1806>
    390e:	00004517          	auipc	a0,0x4
    3912:	03250513          	addi	a0,a0,50 # 7940 <uthread_yield+0x1746>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3926:	0de58593          	addi	a1,a1,222 # 7a00 <uthread_yield+0x1806>
    392a:	00004517          	auipc	a0,0x4
    392e:	04650513          	addi	a0,a0,70 # 7970 <uthread_yield+0x1776>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3942:	e7a58593          	addi	a1,a1,-390 # 77b8 <uthread_yield+0x15be>
    3946:	00004517          	auipc	a0,0x4
    394a:	d6a50513          	addi	a0,a0,-662 # 76b0 <uthread_yield+0x14b6>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    395e:	fe650513          	addi	a0,a0,-26 # 7940 <uthread_yield+0x1746>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3972:	00250513          	addi	a0,a0,2 # 7970 <uthread_yield+0x1776>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3986:	e3650513          	addi	a0,a0,-458 # 77b8 <uthread_yield+0x15be>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399a:	fda50513          	addi	a0,a0,-38 # 7970 <uthread_yield+0x1776>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ae:	f9650513          	addi	a0,a0,-106 # 7940 <uthread_yield+0x1746>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c2:	cf250513          	addi	a0,a0,-782 # 76b0 <uthread_yield+0x14b6>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d6:	17e50513          	addi	a0,a0,382 # 7b50 <uthread_yield+0x1956>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ea:	dd250513          	addi	a0,a0,-558 # 77b8 <uthread_yield+0x15be>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39fe:	cb650513          	addi	a0,a0,-842 # 76b0 <uthread_yield+0x14b6>
  ...
  if(unlink("dd") == 0){
    ...
    3a12:	c8250513          	addi	a0,a0,-894 # 7690 <uthread_yield+0x1496>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a26:	19e50513          	addi	a0,a0,414 # 7bc0 <uthread_yield+0x19c6>
  ...
  if(unlink("dd") < 0){
    ...
    3a3a:	c5a50513          	addi	a0,a0,-934 # 7690 <uthread_yield+0x1496>
    ...
    3a5c:	c4050513          	addi	a0,a0,-960 # 7698 <uthread_yield+0x149e>
    ...
    3a78:	c4450513          	addi	a0,a0,-956 # 76b8 <uthread_yield+0x14be>
    ...
    3a94:	c4850513          	addi	a0,a0,-952 # 76d8 <uthread_yield+0x14de>
    ...
    3ab0:	c6450513          	addi	a0,a0,-924 # 7710 <uthread_yield+0x1516>
    ...
    3acc:	c7850513          	addi	a0,a0,-904 # 7740 <uthread_yield+0x1546>
    ...
    3ae8:	c9450513          	addi	a0,a0,-876 # 7778 <uthread_yield+0x157e>
    ...
    3b04:	c9850513          	addi	a0,a0,-872 # 7798 <uthread_yield+0x159e>
    ...
    3b20:	cac50513          	addi	a0,a0,-852 # 77c8 <uthread_yield+0x15ce>
    ...
    3b3c:	cb850513          	addi	a0,a0,-840 # 77f0 <uthread_yield+0x15f6>
    ...
    3b58:	cbc50513          	addi	a0,a0,-836 # 7810 <uthread_yield+0x1616>
    ...
    3b74:	cc850513          	addi	a0,a0,-824 # 7838 <uthread_yield+0x163e>
    ...
    3b90:	cd450513          	addi	a0,a0,-812 # 7860 <uthread_yield+0x1666>
    ...
    3bac:	ce850513          	addi	a0,a0,-792 # 7890 <uthread_yield+0x1696>
    ...
    3bc8:	cf450513          	addi	a0,a0,-780 # 78b8 <uthread_yield+0x16be>
    ...
    3be4:	cf050513          	addi	a0,a0,-784 # 78d0 <uthread_yield+0x16d6>
    ...
    3c00:	cf450513          	addi	a0,a0,-780 # 78f0 <uthread_yield+0x16f6>
    ...
    3c1c:	cf850513          	addi	a0,a0,-776 # 7910 <uthread_yield+0x1716>
    ...
    3c38:	d1c50513          	addi	a0,a0,-740 # 7950 <uthread_yield+0x1756>
    ...
    3c54:	d3050513          	addi	a0,a0,-720 # 7980 <uthread_yield+0x1786>
    ...
    3c70:	d3450513          	addi	a0,a0,-716 # 79a0 <uthread_yield+0x17a6>
    ...
    3c8c:	d3850513          	addi	a0,a0,-712 # 79c0 <uthread_yield+0x17c6>
    ...
    3ca8:	d3c50513          	addi	a0,a0,-708 # 79e0 <uthread_yield+0x17e6>
    ...
    3cc4:	d5050513          	addi	a0,a0,-688 # 7a10 <uthread_yield+0x1816>
    ...
    3ce0:	d5c50513          	addi	a0,a0,-676 # 7a38 <uthread_yield+0x183e>
    ...
    3cfc:	d6850513          	addi	a0,a0,-664 # 7a60 <uthread_yield+0x1866>
    ...
    3d18:	d7450513          	addi	a0,a0,-652 # 7a88 <uthread_yield+0x188e>
    ...
    3d34:	d7850513          	addi	a0,a0,-648 # 7aa8 <uthread_yield+0x18ae>
    ...
    3d50:	d7c50513          	addi	a0,a0,-644 # 7ac8 <uthread_yield+0x18ce>
    ...
    3d6c:	d8850513          	addi	a0,a0,-632 # 7af0 <uthread_yield+0x18f6>
    ...
    3d88:	d8c50513          	addi	a0,a0,-628 # 7b10 <uthread_yield+0x1916>
    ...
    3da4:	d9050513          	addi	a0,a0,-624 # 7b30 <uthread_yield+0x1936>
    ...
    3dc0:	d9c50513          	addi	a0,a0,-612 # 7b58 <uthread_yield+0x195e>
    ...
    3ddc:	a1850513          	addi	a0,a0,-1512 # 77f0 <uthread_yield+0x15f6>
    ...
    3df8:	d8450513          	addi	a0,a0,-636 # 7b78 <uthread_yield+0x197e>
    ...
    3e14:	d8850513          	addi	a0,a0,-632 # 7b98 <uthread_yield+0x199e>
    ...
    3e30:	d9c50513          	addi	a0,a0,-612 # 7bc8 <uthread_yield+0x19ce>
    ...
    3e4c:	da050513          	addi	a0,a0,-608 # 7be8 <uthread_yield+0x19ee>
...
0000000000003e62 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e72:	d9250513          	addi	a0,a0,-622 # 7c00 <uthread_yield+0x1a06>
  ...
  if(chdir("dots") != 0){
    ...
    3e84:	d8050513          	addi	a0,a0,-640 # 7c00 <uthread_yield+0x1a06>
  ...
  if(unlink(".") == 0){
    ...
    3e96:	b9e50513          	addi	a0,a0,-1122 # 6a30 <uthread_yield+0x836>
  ...
  if(unlink("..") == 0){
    ...
    3ea8:	7b450513          	addi	a0,a0,1972 # 7658 <uthread_yield+0x145e>
  ...
  if(chdir("/") != 0){
    ...
    3eba:	74a50513          	addi	a0,a0,1866 # 7600 <uthread_yield+0x1406>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ecc:	da050513          	addi	a0,a0,-608 # 7c68 <uthread_yield+0x1a6e>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ede:	db650513          	addi	a0,a0,-586 # 7c90 <uthread_yield+0x1a96>
  ...
  if(unlink("dots") != 0){
    ...
    3ef0:	d1450513          	addi	a0,a0,-748 # 7c00 <uthread_yield+0x1a06>
    ...
    3f0e:	cfe50513          	addi	a0,a0,-770 # 7c08 <uthread_yield+0x1a0e>
    ...
    3f2a:	cfa50513          	addi	a0,a0,-774 # 7c20 <uthread_yield+0x1a26>
    ...
    3f46:	cf650513          	addi	a0,a0,-778 # 7c38 <uthread_yield+0x1a3e>
    ...
    3f62:	cf250513          	addi	a0,a0,-782 # 7c50 <uthread_yield+0x1a56>
    ...
    3f7e:	68e50513          	addi	a0,a0,1678 # 7608 <uthread_yield+0x140e>
    ...
    3f9a:	cda50513          	addi	a0,a0,-806 # 7c70 <uthread_yield+0x1a76>
    ...
    3fb6:	ce650513          	addi	a0,a0,-794 # 7c98 <uthread_yield+0x1a9e>
    ...
    3fd2:	cea50513          	addi	a0,a0,-790 # 7cb8 <uthread_yield+0x1abe>
...
0000000000003fe8 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ffe:	cde50513          	addi	a0,a0,-802 # 7cd8 <uthread_yield+0x1ade>
  ...
  if(chdir("dirfile") == 0){
    ...
    401a:	cc250513          	addi	a0,a0,-830 # 7cd8 <uthread_yield+0x1ade>
  ...
  fd = open("dirfile/xx", 0);
    ...
    402e:	cf650513          	addi	a0,a0,-778 # 7d20 <uthread_yield+0x1b26>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4046:	cde50513          	addi	a0,a0,-802 # 7d20 <uthread_yield+0x1b26>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405a:	cca50513          	addi	a0,a0,-822 # 7d20 <uthread_yield+0x1b26>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    406e:	cb650513          	addi	a0,a0,-842 # 7d20 <uthread_yield+0x1b26>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4082:	ca258593          	addi	a1,a1,-862 # 7d20 <uthread_yield+0x1b26>
    4086:	00002517          	auipc	a0,0x2
    408a:	49a50513          	addi	a0,a0,1178 # 6520 <uthread_yield+0x326>
  ...
  if(unlink("dirfile") != 0){
    ...
    409e:	c3e50513          	addi	a0,a0,-962 # 7cd8 <uthread_yield+0x1ade>
  ...
  fd = open(".", O_RDWR);
    ...
    40b4:	98050513          	addi	a0,a0,-1664 # 6a30 <uthread_yield+0x836>
  ...
  fd = open(".", 0);
    ...
    40ca:	96a50513          	addi	a0,a0,-1686 # 6a30 <uthread_yield+0x836>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40de:	2de58593          	addi	a1,a1,734 # 63b8 <uthread_yield+0x1be>
  ...
  close(fd);
    ...
    410a:	bda50513          	addi	a0,a0,-1062 # 7ce0 <uthread_yield+0x1ae6>
    ...
    4126:	bde50513          	addi	a0,a0,-1058 # 7d00 <uthread_yield+0x1b06>
    ...
    4142:	bf250513          	addi	a0,a0,-1038 # 7d30 <uthread_yield+0x1b36>
    ...
    415e:	bd650513          	addi	a0,a0,-1066 # 7d30 <uthread_yield+0x1b36>
    ...
    417a:	be250513          	addi	a0,a0,-1054 # 7d58 <uthread_yield+0x1b5e>
    ...
    4196:	bee50513          	addi	a0,a0,-1042 # 7d80 <uthread_yield+0x1b86>
    ...
    41b2:	bfa50513          	addi	a0,a0,-1030 # 7da8 <uthread_yield+0x1bae>
    ...
    41ce:	c0650513          	addi	a0,a0,-1018 # 7dd0 <uthread_yield+0x1bd6>
    ...
    41ea:	c0a50513          	addi	a0,a0,-1014 # 7df0 <uthread_yield+0x1bf6>
    ...
    4206:	c1650513          	addi	a0,a0,-1002 # 7e18 <uthread_yield+0x1c1e>
...
000000000000421c <iref>:
{
    ...
    423a:	bfaa0a13          	addi	s4,s4,-1030 # 7e30 <uthread_yield+0x1c36>
    mkdir("");
    423e:	00003497          	auipc	s1,0x3
    4242:	6fa48493          	addi	s1,s1,1786 # 7938 <uthread_yield+0x173e>
    link("README", "");
    4246:	00002a97          	auipc	s5,0x2
    424a:	2daa8a93          	addi	s5,s5,730 # 6520 <uthread_yield+0x326>
    fd = open("xx", O_CREATE);
    424e:	00004997          	auipc	s3,0x4
    4252:	ada98993          	addi	s3,s3,-1318 # 7d28 <uthread_yield+0x1b2e>
    4256:	a891                	j	42aa <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4258:	85da                	mv	a1,s6
    425a:	00004517          	auipc	a0,0x4
    425e:	bde50513          	addi	a0,a0,-1058 # 7e38 <uthread_yield+0x1c3e>
    ...
    427a:	bda50513          	addi	a0,a0,-1062 # 7e50 <uthread_yield+0x1c56>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    430e:	34e98993          	addi	s3,s3,846 # 7658 <uthread_yield+0x145e>
    unlink("irefd");
    4312:	00004917          	auipc	s2,0x4
    4316:	b1e90913          	addi	s2,s2,-1250 # 7e30 <uthread_yield+0x1c36>
    chdir("..");
    431a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4336:	2ce50513          	addi	a0,a0,718 # 7600 <uthread_yield+0x1406>
...
0000000000004356 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4366:	b0650513          	addi	a0,a0,-1274 # 7e68 <uthread_yield+0x1c6e>
  ...
  if(pid == 0){
    ...
    438a:	ae250513          	addi	a0,a0,-1310 # 7e68 <uthread_yield+0x1c6e>
    ...
    43a0:	aec50513          	addi	a0,a0,-1300 # 7e88 <uthread_yield+0x1c8e>
    ...
    43bc:	ab850513          	addi	a0,a0,-1352 # 7e70 <uthread_yield+0x1c76>
    ...
    43d8:	7fc50513          	addi	a0,a0,2044 # 6bd0 <uthread_yield+0x9d6>
  ...
  if(unlink("oidir") != 0){
    ...
    4406:	a6650513          	addi	a0,a0,-1434 # 7e68 <uthread_yield+0x1c6e>
    ...
    441a:	9aa50513          	addi	a0,a0,-1622 # 6dc0 <uthread_yield+0xbc6>
...
0000000000004448 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4458:	a5c50513          	addi	a0,a0,-1444 # 7eb0 <uthread_yield+0x1cb6>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4484:	a3050513          	addi	a0,a0,-1488 # 7eb0 <uthread_yield+0x1cb6>
  ...
  sleep(10); // one second
    ...
    44bc:	8d850513          	addi	a0,a0,-1832 # 6d90 <uthread_yield+0xb96>
    ...
    44d6:	9de48493          	addi	s1,s1,-1570 # 7eb0 <uthread_yield+0x1cb6>
    44da:	4581                	li	a1,0
    44dc:	8526                	mv	a0,s1
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	65650513          	addi	a0,a0,1622 # 6bd0 <uthread_yield+0x9d6>
    ...
    45a4:	92050513          	addi	a0,a0,-1760 # 7ec0 <uthread_yield+0x1cc6>
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	7b050513          	addi	a0,a0,1968 # 6d90 <uthread_yield+0xb96>
  ...
  if(pid2 == 0)
    ...
    4612:	5c250513          	addi	a0,a0,1474 # 6bd0 <uthread_yield+0x9d6>
  ...
  if(pid3 == 0){
    ...
    4656:	d6658593          	addi	a1,a1,-666 # 63b8 <uthread_yield+0x1be>
    ...
    4680:	55450513          	addi	a0,a0,1364 # 6bd0 <uthread_yield+0x9d6>
    ...
    469c:	84850513          	addi	a0,a0,-1976 # 7ee0 <uthread_yield+0x1ce6>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	82450513          	addi	a0,a0,-2012 # 7ef8 <uthread_yield+0x1cfe>
  ...
  printf("kill... ");
    ...
    4704:	81050513          	addi	a0,a0,-2032 # 7f10 <uthread_yield+0x1d16>
  ...
  printf("wait... ");
    ...
    4732:	7f250513          	addi	a0,a0,2034 # 7f20 <uthread_yield+0x1d26>
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	42250513          	addi	a0,a0,1058 # 6bd0 <uthread_yield+0x9d6>
    ...
    47ce:	58e50513          	addi	a0,a0,1422 # 6d58 <uthread_yield+0xb5e>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	49850513          	addi	a0,a0,1176 # 6cd8 <uthread_yield+0xade>
    ...
    4878:	b4458593          	addi	a1,a1,-1212 # 63b8 <uthread_yield+0x1be>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	5f850513          	addi	a0,a0,1528 # 7f30 <uthread_yield+0x1d36>
    ...
    4958:	27c50513          	addi	a0,a0,636 # 6bd0 <uthread_yield+0x9d6>
    ...
    498e:	6705                	lui	a4,0x1
      n += *(a+i);
    4990:	0007c683          	lbu	a3,0(a5) # 6400000 <uthreads_arr+0x63f0368>
    ...
    49a4:	5b050513          	addi	a0,a0,1456 # 7f50 <uthread_yield+0x1d56>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a48:	53c50513          	addi	a0,a0,1340 # 7f80 <uthread_yield+0x1d86>
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	4b650513          	addi	a0,a0,1206 # 7fb0 <uthread_yield+0x1db6>
    ...
    4b1a:	4c250513          	addi	a0,a0,1218 # 7fd8 <uthread_yield+0x1dde>
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	44650513          	addi	a0,a0,1094 # 7fa0 <uthread_yield+0x1da6>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	45e50513          	addi	a0,a0,1118 # 7ff8 <uthread_yield+0x1dfe>
  ...
  unlink("sharedfd");
    ...
    4bda:	3ca50513          	addi	a0,a0,970 # 7fa0 <uthread_yield+0x1da6>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	42450513          	addi	a0,a0,1060 # 8020 <uthread_yield+0x1e26>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c46:	6ae78793          	addi	a5,a5,1710 # 62f0 <uthread_yield+0xf6>
    4c4a:	f6f43823          	sd	a5,-144(s0)
    4c4e:	00001797          	auipc	a5,0x1
    4c52:	6aa78793          	addi	a5,a5,1706 # 62f8 <uthread_yield+0xfe>
    4c56:	f6f43c23          	sd	a5,-136(s0)
    4c5a:	00001797          	auipc	a5,0x1
    4c5e:	6a678793          	addi	a5,a5,1702 # 6300 <uthread_yield+0x106>
    4c62:	f8f43023          	sd	a5,-128(s0)
    4c66:	00001797          	auipc	a5,0x1
    4c6a:	6a278793          	addi	a5,a5,1698 # 6308 <uthread_yield+0x10e>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce2:	2fa50513          	addi	a0,a0,762 # 6fd8 <uthread_yield+0xdde>
    ...
    4d5e:	2de50513          	addi	a0,a0,734 # 8038 <uthread_yield+0x1e3e>
    ...
    4d78:	2d450513          	addi	a0,a0,724 # 8048 <uthread_yield+0x1e4e>
    ...
    4da0:	2c450513          	addi	a0,a0,708 # 8060 <uthread_yield+0x1e66>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2e:	24650513          	addi	a0,a0,582 # 8070 <uthread_yield+0x1e76>
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	1fcb8b93          	addi	s7,s7,508 # 8088 <uthread_yield+0x1e8e>
  for(i = 0; i < N; i++){
    ...
    4ed2:	1c250513          	addi	a0,a0,450 # 8090 <uthread_yield+0x1e96>
    ...
    4ef0:	19c50513          	addi	a0,a0,412 # 8088 <uthread_yield+0x1e8e>
  ...
  fd = open(".", 0);
    ...
    4f28:	b0c50513          	addi	a0,a0,-1268 # 6a30 <uthread_yield+0x836>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9e:	11650513          	addi	a0,a0,278 # 80b0 <uthread_yield+0x1eb6>
    ...
    4fbe:	11650513          	addi	a0,a0,278 # 80d0 <uthread_yield+0x1ed6>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	10650513          	addi	a0,a0,262 # 80f8 <uthread_yield+0x1efe>
    ...
    5012:	bc250513          	addi	a0,a0,-1086 # 6bd0 <uthread_yield+0x9d6>
...
00000000000051bc <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	ef050513          	addi	a0,a0,-272 # 8130 <uthread_yield+0x1f36>
  ...
  for(i = 0; ; i++){
    ...
    52a8:	e9c50513          	addi	a0,a0,-356 # 8140 <uthread_yield+0x1f46>
    ...
    52c4:	ea050513          	addi	a0,a0,-352 # 8160 <uthread_yield+0x1f66>
    ...
    52e0:	ea450513          	addi	a0,a0,-348 # 8180 <uthread_yield+0x1f86>
    ...
    52fc:	ea850513          	addi	a0,a0,-344 # 81a0 <uthread_yield+0x1fa6>
    ...
    5318:	eac50513          	addi	a0,a0,-340 # 81c0 <uthread_yield+0x1fc6>
    ...
    5334:	ea850513          	addi	a0,a0,-344 # 81d8 <uthread_yield+0x1fde>
  ...
  unlink("bigfile.dat");
    ...
    5362:	dd250513          	addi	a0,a0,-558 # 8130 <uthread_yield+0x1f36>
    ...
    5386:	e7650513          	addi	a0,a0,-394 # 81f8 <uthread_yield+0x1ffe>
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	e5e50513          	addi	a0,a0,-418 # 8218 <uthread_yield+0x201e>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53de:	e4ec8c93          	addi	s9,s9,-434 # 8228 <uthread_yield+0x202e>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5458:	de450513          	addi	a0,a0,-540 # 8238 <uthread_yield+0x203e>
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	d8e50513          	addi	a0,a0,-626 # 8258 <uthread_yield+0x205e>
    ...
    551e:	d2e50513          	addi	a0,a0,-722 # 8248 <uthread_yield+0x204e>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	d2450513          	addi	a0,a0,-732 # 8270 <uthread_yield+0x2076>
  ...
  if(pid == 0) {
    ...
    5580:	d1c50513          	addi	a0,a0,-740 # 8298 <uthread_yield+0x209e>
    ...
    55a4:	ce050513          	addi	a0,a0,-800 # 8280 <uthread_yield+0x2086>
    ...
    55cc:	cd850513          	addi	a0,a0,-808 # 82a0 <uthread_yield+0x20a6>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	c9050513          	addi	a0,a0,-880 # 82a8 <uthread_yield+0x20ae>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	d4698993          	addi	s3,s3,-698 # 63b8 <uthread_yield+0x1be>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a8:	c5c50513          	addi	a0,a0,-932 # 8300 <uthread_yield+0x2106>
    ...
    56c2:	c0250513          	addi	a0,a0,-1022 # 82c0 <uthread_yield+0x20c6>
    ...
    56dc:	c0850513          	addi	a0,a0,-1016 # 82e0 <uthread_yield+0x20e6>
  ...
  while(1){
    ...
    572a:	bfa50513          	addi	a0,a0,-1030 # 8320 <uthread_yield+0x2126>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	bb8b8b93          	addi	s7,s7,-1096 # 8340 <uthread_yield+0x2146>
    int free0 = countfree();
    int free1 = 0;
    ...
    579e:	bdec8c93          	addi	s9,s9,-1058 # 8378 <uthread_yield+0x217e>
      if (runtests(slowtests, justone)) {
    57a2:	00004c17          	auipc	s8,0x4
    57a6:	c3ec0c13          	addi	s8,s8,-962 # 93e0 <slowtests>
        printf("usertests slow tests starting\n");
    57aa:	00003d17          	auipc	s10,0x3
    57ae:	baed0d13          	addi	s10,s10,-1106 # 8358 <uthread_yield+0x215e>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a4:	b0858593          	addi	a1,a1,-1272 # 83a8 <uthread_yield+0x21ae>
    ...
    58ba:	b4a58593          	addi	a1,a1,-1206 # 8400 <uthread_yield+0x2206>
    ...
    58d0:	b2c58593          	addi	a1,a1,-1236 # 83f8 <uthread_yield+0x21fe>
  ...
  int continuous = 0;
    ...
    58fc:	ab850513          	addi	a0,a0,-1352 # 83b0 <uthread_yield+0x21b6>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	abc50513          	addi	a0,a0,-1348 # 83e0 <uthread_yield+0x21e6>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cae:	ac650513          	addi	a0,a0,-1338 # 8770 <digits>
    5cb2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d7a:	9fab8b93          	addi	s7,s7,-1542 # 8770 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5eba:	8b290913          	addi	s2,s2,-1870 # 8768 <uthread_yield+0x256e>
        while(*s != 0){
...
void uthread_exit(){
    ...
    6150:	6422                	ld	s0,8(sp)
    6152:	0141                	addi	sp,sp,16
    6154:	8082                	ret

0000000000006156 <uthread_create>:
int uthread_create(void (*start_func)(), enum sched_priority priority) {
    6156:	862e                	mv	a2,a1
    for (i = 0; i < MAX_UTHREADS; i++) {
    6158:	0000b717          	auipc	a4,0xb
    615c:	ae470713          	addi	a4,a4,-1308 # 10c3c <uthreads_arr+0xfa4>
    6160:	4781                	li	a5,0
    6162:	6805                	lui	a6,0x1
    6164:	02080813          	addi	a6,a6,32 # 1020 <linktest+0x12a>
    6168:	4591                	li	a1,4
        if (uthreads_arr[i].state == FREE) {
    616a:	4314                	lw	a3,0(a4)
    616c:	c699                	beqz	a3,617a <uthread_create+0x24>
    for (i = 0; i < MAX_UTHREADS; i++) {
    616e:	2785                	addiw	a5,a5,1
    6170:	9742                	add	a4,a4,a6
    6172:	feb79ce3          	bne	a5,a1,616a <uthread_create+0x14>
        return -1;
    6176:	557d                	li	a0,-1
    6178:	8082                	ret
            curr_thread = &uthreads_arr[i];
    617a:	00779713          	slli	a4,a5,0x7
    617e:	973e                	add	a4,a4,a5
    6180:	0716                	slli	a4,a4,0x5
    6182:	0000a697          	auipc	a3,0xa
    6186:	b1668693          	addi	a3,a3,-1258 # fc98 <uthreads_arr>
    618a:	9736                	add	a4,a4,a3
    618c:	00003697          	auipc	a3,0x3
    6190:	2ce6b623          	sd	a4,716(a3) # 9458 <curr_thread>
    if (i >= MAX_UTHREADS) {
    6194:	468d                	li	a3,3
    6196:	06f6c063          	blt	a3,a5,61f6 <uthread_create+0xa0>
int uthread_create(void (*start_func)(), enum sched_priority priority) {
    619a:	1141                	addi	sp,sp,-16
    619c:	e406                	sd	ra,8(sp)
    619e:	e022                	sd	s0,0(sp)
    61a0:	0800                	addi	s0,sp,16
    curr_thread->id = next_tid++; 
    61a2:	00003797          	auipc	a5,0x3
    61a6:	2be78793          	addi	a5,a5,702 # 9460 <next_tid>
    61aa:	438c                	lw	a1,0(a5)
    61ac:	0015869b          	addiw	a3,a1,1
    61b0:	c394                	sw	a3,0(a5)
    61b2:	c30c                	sw	a1,0(a4)
    curr_thread->priority = priority;
    61b4:	6685                	lui	a3,0x1
    61b6:	00d707b3          	add	a5,a4,a3
    61ba:	cf90                	sw	a2,24(a5)
    curr_thread->context.ra = (uint64) start_func;
    61bc:	faa7b423          	sd	a0,-88(a5)
    curr_thread->context.sp = (uint64) &curr_thread->ustack[STACK_SIZE];
    61c0:	fa468693          	addi	a3,a3,-92 # fa4 <linktest+0xae>
    61c4:	9736                	add	a4,a4,a3
    61c6:	fae7b823          	sd	a4,-80(a5)
    curr_thread->ustack[STACK_SIZE - 1] = (uint64) uthread_exit; // Return address to uthread_exit
    61ca:	00000717          	auipc	a4,0x0
    61ce:	f8070713          	addi	a4,a4,-128 # 614a <uthread_exit>
    61d2:	fae781a3          	sb	a4,-93(a5)
    curr_thread->state = RUNNABLE;
    61d6:	4709                	li	a4,2
    61d8:	fae7a223          	sw	a4,-92(a5)
 printf("Created thread with ID: %d and prior:%d\n", curr_thread->id,curr_thread->priority);
    61dc:	00002517          	auipc	a0,0x2
    61e0:	5ac50513          	addi	a0,a0,1452 # 8788 <digits+0x18>
    61e4:	00000097          	auipc	ra,0x0
    61e8:	d5a080e7          	jalr	-678(ra) # 5f3e <printf>
     return 0;
    61ec:	4501                	li	a0,0
}
    61ee:	60a2                	ld	ra,8(sp)
    61f0:	6402                	ld	s0,0(sp)
    61f2:	0141                	addi	sp,sp,16
    61f4:	8082                	ret
        return -1;
    61f6:	557d                	li	a0,-1
}
...
00000000000061fa <uthread_yield>:
void uthread_yield() {
    61fa:	7179                	addi	sp,sp,-48
    61fc:	f406                	sd	ra,40(sp)
    61fe:	f022                	sd	s0,32(sp)
    6200:	ec26                	sd	s1,24(sp)
    6202:	e84a                	sd	s2,16(sp)
    6204:	e44e                	sd	s3,8(sp)
    6206:	1800                	addi	s0,sp,48
    for (int i = curr_thread->id+1; count<MAX_UTHREADS; count++, i=(i+1)%MAX_UTHREADS) {
    6208:	00003817          	auipc	a6,0x3
    620c:	25083803          	ld	a6,592(a6) # 9458 <curr_thread>
    6210:	00082583          	lw	a1,0(a6)
    6214:	0015879b          	addiw	a5,a1,1
    6218:	4691                	li	a3,4
    ...
    621e:	0000a617          	auipc	a2,0xa
    6222:	a7a60613          	addi	a2,a2,-1414 # fc98 <uthreads_arr>
    6226:	6505                	lui	a0,0x1
    6228:	4889                	li	a7,2
    622a:	a819                	j	6240 <uthread_yield+0x46>
    for (int i = curr_thread->id+1; count<MAX_UTHREADS; count++, i=(i+1)%MAX_UTHREADS) {
    622c:	2785                	addiw	a5,a5,1
    622e:	41f7d71b          	sraiw	a4,a5,0x1f
    6232:	01e7571b          	srliw	a4,a4,0x1e
    6236:	9fb9                	addw	a5,a5,a4
    6238:	8b8d                	andi	a5,a5,3
    623a:	9f99                	subw	a5,a5,a4
    623c:	36fd                	addiw	a3,a3,-1
    623e:	ca9d                	beqz	a3,6274 <uthread_yield+0x7a>
        if (uthreads_arr[i].state == RUNNABLE &&
    6240:	00779713          	slli	a4,a5,0x7
    6244:	973e                	add	a4,a4,a5
    6246:	0716                	slli	a4,a4,0x5
    6248:	9732                	add	a4,a4,a2
    624a:	972a                	add	a4,a4,a0
    624c:	fa472703          	lw	a4,-92(a4)
    6250:	fd171ee3          	bne	a4,a7,622c <uthread_yield+0x32>
            uthreads_arr[i].priority > max_priority) {
    6254:	00779713          	slli	a4,a5,0x7
    6258:	973e                	add	a4,a4,a5
    625a:	0716                	slli	a4,a4,0x5
    625c:	9732                	add	a4,a4,a2
    625e:	972a                	add	a4,a4,a0
    6260:	4f18                	lw	a4,24(a4)
        if (uthreads_arr[i].state == RUNNABLE &&
    6262:	fce375e3          	bgeu	t1,a4,622c <uthread_yield+0x32>
            next_thread = &uthreads_arr[i];
    6266:	00779493          	slli	s1,a5,0x7
    626a:	94be                	add	s1,s1,a5
    626c:	0496                	slli	s1,s1,0x5
    626e:	94b2                	add	s1,s1,a2
            max_priority = uthreads_arr[i].priority;
    6270:	833a                	mv	t1,a4
    6272:	bf6d                	j	622c <uthread_yield+0x32>
     printf("before switch thread with ID: %d and prior:%d\n", curr_thread->id,curr_thread->priority);
    6274:	6785                	lui	a5,0x1
    6276:	983e                	add	a6,a6,a5
    6278:	01882603          	lw	a2,24(a6)
    627c:	00002517          	auipc	a0,0x2
    6280:	53c50513          	addi	a0,a0,1340 # 87b8 <digits+0x48>
    6284:	00000097          	auipc	ra,0x0
    6288:	cba080e7          	jalr	-838(ra) # 5f3e <printf>
    if (next_thread == NULL) {
    628c:	c8b9                	beqz	s1,62e2 <uthread_yield+0xe8>
    struct context *curr_context = &curr_thread->context;
    628e:	00003997          	auipc	s3,0x3
    6292:	1ca98993          	addi	s3,s3,458 # 9458 <curr_thread>
    6296:	0009b503          	ld	a0,0(s3)
    curr_thread->state = RUNNABLE;
    629a:	6905                	lui	s2,0x1
    629c:	012507b3          	add	a5,a0,s2
    62a0:	4709                	li	a4,2
    62a2:	fae7a223          	sw	a4,-92(a5) # fa4 <linktest+0xae>
    next_thread->state = RUNNING;
    62a6:	012487b3          	add	a5,s1,s2
    62aa:	4705                	li	a4,1
    62ac:	fae7a223          	sw	a4,-92(a5)
    curr_thread = next_thread;
    62b0:	0099b023          	sd	s1,0(s3)
    struct context *next_context = &next_thread->context;
    62b4:	fa890793          	addi	a5,s2,-88 # fa8 <linktest+0xb2>
    uswtch(curr_context, next_context);
    62b8:	00f485b3          	add	a1,s1,a5
    62bc:	953e                	add	a0,a0,a5
    62be:	00000097          	auipc	ra,0x0
    62c2:	e22080e7          	jalr	-478(ra) # 60e0 <uswtch>
         printf("after switch thread with ID: %d and prior:%d\n", curr_thread->id,curr_thread->priority);
    62c6:	0009b783          	ld	a5,0(s3)
    62ca:	993e                	add	s2,s2,a5
    62cc:	01892603          	lw	a2,24(s2)
    62d0:	438c                	lw	a1,0(a5)
    62d2:	00002517          	auipc	a0,0x2
    62d6:	51650513          	addi	a0,a0,1302 # 87e8 <digits+0x78>
    62da:	00000097          	auipc	ra,0x0
    62de:	c64080e7          	jalr	-924(ra) # 5f3e <printf>
}
    62e2:	70a2                	ld	ra,40(sp)
    62e4:	7402                	ld	s0,32(sp)
    62e6:	64e2                	ld	s1,24(sp)
    62e8:	6942                	ld	s2,16(sp)
    62ea:	69a2                	ld	s3,8(sp)
    62ec:	6145                	addi	sp,sp,48
    62ee:	8082                	ret
