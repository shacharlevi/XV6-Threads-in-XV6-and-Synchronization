...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	67e58593          	addi	a1,a1,1662 # 1690 <uthread_self+0x22>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	63858593          	addi	a1,a1,1592 # 1698 <uthread_self+0x2a>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	60650513          	addi	a0,a0,1542 # 16a0 <uthread_self+0x32>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	6d270713          	addi	a4,a4,1746 # 1798 <uthread_self+0x12a>
    ...
    panic("runcmd");
      ...
      e4:	5c850513          	addi	a0,a0,1480 # 16a8 <uthread_self+0x3a>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	5ae58593          	addi	a1,a1,1454 # 16b0 <uthread_self+0x42>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	57258593          	addi	a1,a1,1394 # 16c0 <uthread_self+0x52>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	4ec50513          	addi	a0,a0,1260 # 16d0 <uthread_self+0x62>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	154b8b93          	addi	s7,s7,340 # 16f8 <uthread_self+0x8a>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	12250513          	addi	a0,a0,290 # 16d8 <uthread_self+0x6a>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	06260613          	addi	a2,a2,98 # 1700 <uthread_self+0x92>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	052b0b13          	addi	s6,s6,82 # 1720 <uthread_self+0xb2>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	fa650513          	addi	a0,a0,-90 # 1710 <uthread_self+0xa2>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	f8460613          	addi	a2,a2,-124 # 1728 <uthread_self+0xba>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	f1ca0a13          	addi	s4,s4,-228 # 1730 <uthread_self+0xc2>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	eee60613          	addi	a2,a2,-274 # 1738 <uthread_self+0xca>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	e5060613          	addi	a2,a2,-432 # 1700 <uthread_self+0x92>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	e7060613          	addi	a2,a2,-400 # 1750 <uthread_self+0xe2>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	e1e50513          	addi	a0,a0,-482 # 1740 <uthread_self+0xd2>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	e2650513          	addi	a0,a0,-474 # 1758 <uthread_self+0xea>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	e5270713          	addi	a4,a4,-430 # 17b0 <uthread_self+0x142>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	dee60613          	addi	a2,a2,-530 # 17f8 <digits+0x28>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a44:	d3058593          	addi	a1,a1,-720 # 1770 <uthread_self+0x102>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	706080e7          	jalr	1798(ra) # 1150 <fprintf>
    panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	cb650513          	addi	a0,a0,-842 # 1708 <uthread_self+0x9a>
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a78:	d0c48493          	addi	s1,s1,-756 # 1780 <uthread_self+0x112>
     a7c:	4589                	li	a1,2
     a7e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     ab6:	cd6a8a93          	addi	s5,s5,-810 # 1788 <uthread_self+0x11a>
...
0000000000000e7e <kthread_create>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eee:	8e650513          	addi	a0,a0,-1818 # 17d0 <digits>
     ef2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fb6:	00001b97          	auipc	s7,0x1
     fba:	81ab8b93          	addi	s7,s7,-2022 # 17d0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10fa:	6d290913          	addi	s2,s2,1746 # 17c8 <uthread_self+0x15a>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    1298:	e0478793          	addi	a5,a5,-508 # 2098 <base>
...
0000000000001320 <uswtch>:
    1320:	00153023          	sd	ra,0(a0)
    1324:	00253423          	sd	sp,8(a0)
    1328:	e900                	sd	s0,16(a0)
    132a:	ed04                	sd	s1,24(a0)
    132c:	03253023          	sd	s2,32(a0)
    1330:	03353423          	sd	s3,40(a0)
    1334:	03453823          	sd	s4,48(a0)
    1338:	03553c23          	sd	s5,56(a0)
    133c:	05653023          	sd	s6,64(a0)
    1340:	05753423          	sd	s7,72(a0)
    1344:	05853823          	sd	s8,80(a0)
    1348:	05953c23          	sd	s9,88(a0)
    134c:	07a53023          	sd	s10,96(a0)
    1350:	07b53423          	sd	s11,104(a0)
    1354:	0005b083          	ld	ra,0(a1)
    1358:	0085b103          	ld	sp,8(a1)
    135c:	6980                	ld	s0,16(a1)
    135e:	6d84                	ld	s1,24(a1)
    1360:	0205b903          	ld	s2,32(a1)
    1364:	0285b983          	ld	s3,40(a1)
    1368:	0305ba03          	ld	s4,48(a1)
    136c:	0385ba83          	ld	s5,56(a1)
    1370:	0405bb03          	ld	s6,64(a1)
    1374:	0485bb83          	ld	s7,72(a1)
    1378:	0505bc03          	ld	s8,80(a1)
    137c:	0585bc83          	ld	s9,88(a1)
    1380:	0605bd03          	ld	s10,96(a1)
    1384:	0685bd83          	ld	s11,104(a1)
    1388:	8082                	ret

000000000000138a <uthread_exit>:
...
void uthread_exit(){
    ...
    1396:	45650513          	addi	a0,a0,1110 # 17e8 <digits+0x18>
    139a:	00000097          	auipc	ra,0x0
    139e:	de4080e7          	jalr	-540(ra) # 117e <printf>
    // Change the state of the current thread to FREE
    curr_thread->state = FREE;
    13a2:	00001517          	auipc	a0,0x1
    13a6:	c7653503          	ld	a0,-906(a0) # 2018 <curr_thread>
    13aa:	6785                	lui	a5,0x1
    13ac:	97aa                	add	a5,a5,a0
    13ae:	fa07a223          	sw	zero,-92(a5) # fa4 <vprintf+0x32>
    ...
    13b2:	411c                	lw	a5,0(a0)
    13b4:	2785                	addiw	a5,a5,1
    13b6:	4691                	li	a3,4
    enum sched_priority max_priority = LOW;
    13b8:	4301                	li	t1,0
    struct uthread *next_thread = (struct uthread *) 1;
    ...
    13bc:	00001617          	auipc	a2,0x1
    13c0:	d5c60613          	addi	a2,a2,-676 # 2118 <uthreads_arr>
    13c4:	6805                	lui	a6,0x1
    13c6:	4889                	li	a7,2
    13c8:	a819                	j	13de <uthread_exit+0x54>
    for (int i = curr_thread->id+1; count<MAX_UTHREADS;  count++,i=(i+1)%MAX_UTHREADS) {
    13ca:	2785                	addiw	a5,a5,1
    13cc:	41f7d71b          	sraiw	a4,a5,0x1f
    13d0:	01e7571b          	srliw	a4,a4,0x1e
    13d4:	9fb9                	addw	a5,a5,a4
    13d6:	8b8d                	andi	a5,a5,3
    13d8:	9f99                	subw	a5,a5,a4
    13da:	36fd                	addiw	a3,a3,-1
    13dc:	ca9d                	beqz	a3,1412 <uthread_exit+0x88>
        if (uthreads_arr[i].state == RUNNABLE &&
    13de:	00779713          	slli	a4,a5,0x7
    13e2:	973e                	add	a4,a4,a5
    13e4:	0716                	slli	a4,a4,0x5
    13e6:	9732                	add	a4,a4,a2
    13e8:	9742                	add	a4,a4,a6
    13ea:	fa472703          	lw	a4,-92(a4)
    13ee:	fd171ee3          	bne	a4,a7,13ca <uthread_exit+0x40>
            uthreads_arr[i].priority > max_priority) {
    13f2:	00779713          	slli	a4,a5,0x7
    13f6:	973e                	add	a4,a4,a5
    13f8:	0716                	slli	a4,a4,0x5
    13fa:	9732                	add	a4,a4,a2
    13fc:	9742                	add	a4,a4,a6
    13fe:	4f18                	lw	a4,24(a4)
        if (uthreads_arr[i].state == RUNNABLE &&
    1400:	fce375e3          	bgeu	t1,a4,13ca <uthread_exit+0x40>
            next_thread = &uthreads_arr[i];
    1404:	00779593          	slli	a1,a5,0x7
    1408:	95be                	add	a1,a1,a5
    140a:	0596                	slli	a1,a1,0x5
    140c:	95b2                	add	a1,a1,a2
            max_priority = uthreads_arr[i].priority;
    140e:	833a                	mv	t1,a4
    1410:	bf6d                	j	13ca <uthread_exit+0x40>
        }
    }
    if (next_thread == (struct uthread *) 1) {
    1412:	4785                	li	a5,1
    1414:	02f58863          	beq	a1,a5,1444 <uthread_exit+0xba>
    ...
    1418:	6785                	lui	a5,0x1
    141a:	00f58733          	add	a4,a1,a5
    141e:	4685                	li	a3,1
    1420:	fad72223          	sw	a3,-92(a4)
    curr_thread = next_thread;
    1424:	00001717          	auipc	a4,0x1
    1428:	beb73a23          	sd	a1,-1036(a4) # 2018 <curr_thread>
    struct context *next_context = &next_thread->context;
    142c:	fa878793          	addi	a5,a5,-88 # fa8 <vprintf+0x36>
    uswtch(curr_context, next_context);
    1430:	95be                	add	a1,a1,a5
    1432:	953e                	add	a0,a0,a5
    1434:	00000097          	auipc	ra,0x0
    1438:	eec080e7          	jalr	-276(ra) # 1320 <uswtch>
}
    ...
    144a:	998080e7          	jalr	-1640(ra) # dde <exit>

000000000000144e <uthread_create>:
int uthread_create(void (*start_func)(), enum sched_priority priority) {
    144e:	1141                	addi	sp,sp,-16
    1450:	e422                	sd	s0,8(sp)
    1452:	0800                	addi	s0,sp,16
    for (i = 0; i < MAX_UTHREADS; i++) {
    1454:	00002717          	auipc	a4,0x2
    1458:	c6870713          	addi	a4,a4,-920 # 30bc <uthreads_arr+0xfa4>
    145c:	4781                	li	a5,0
    145e:	6605                	lui	a2,0x1
    1460:	02060613          	addi	a2,a2,32 # 1020 <vprintf+0xae>
    1464:	4811                	li	a6,4
        if (uthreads_arr[i].state == FREE) {
    1466:	4314                	lw	a3,0(a4)
    1468:	c699                	beqz	a3,1476 <uthread_create+0x28>
    for (i = 0; i < MAX_UTHREADS; i++) {
    146a:	2785                	addiw	a5,a5,1
    146c:	9732                	add	a4,a4,a2
    146e:	ff079ce3          	bne	a5,a6,1466 <uthread_create+0x18>
        return -1;
    1472:	557d                	li	a0,-1
    1474:	a0b9                	j	14c2 <uthread_create+0x74>
            curr_thread = &uthreads_arr[i];
    1476:	00779713          	slli	a4,a5,0x7
    147a:	973e                	add	a4,a4,a5
    147c:	0716                	slli	a4,a4,0x5
    147e:	00001697          	auipc	a3,0x1
    1482:	c9a68693          	addi	a3,a3,-870 # 2118 <uthreads_arr>
    1486:	9736                	add	a4,a4,a3
    1488:	00001697          	auipc	a3,0x1
    148c:	b8e6b823          	sd	a4,-1136(a3) # 2018 <curr_thread>
    if (i >= MAX_UTHREADS) {
    1490:	468d                	li	a3,3
    1492:	02f6cb63          	blt	a3,a5,14c8 <uthread_create+0x7a>
    curr_thread->id = i; 
    1496:	c31c                	sw	a5,0(a4)
    curr_thread->priority = priority;
    1498:	6685                	lui	a3,0x1
    149a:	00d707b3          	add	a5,a4,a3
    149e:	cf8c                	sw	a1,24(a5)
    curr_thread->context.ra = (uint64) start_func;
    14a0:	faa7b423          	sd	a0,-88(a5)
    curr_thread->context.sp = (uint64) &curr_thread->ustack[STACK_SIZE];
    14a4:	fa468693          	addi	a3,a3,-92 # fa4 <vprintf+0x32>
    14a8:	9736                	add	a4,a4,a3
    14aa:	fae7b823          	sd	a4,-80(a5)
    curr_thread->ustack[STACK_SIZE - 1] = (uint64) uthread_exit; // Return address to uthread_exit
    14ae:	00000717          	auipc	a4,0x0
    14b2:	edc70713          	addi	a4,a4,-292 # 138a <uthread_exit>
    14b6:	fae781a3          	sb	a4,-93(a5)
    curr_thread->state = RUNNABLE;
    14ba:	4709                	li	a4,2
    14bc:	fae7a223          	sw	a4,-92(a5)
     return 0;
    14c0:	4501                	li	a0,0
}
    14c2:	6422                	ld	s0,8(sp)
    14c4:	0141                	addi	sp,sp,16
    14c6:	8082                	ret
        return -1;
    14c8:	557d                	li	a0,-1
    14ca:	bfe5                	j	14c2 <uthread_create+0x74>

00000000000014cc <uthread_yield>:
    for (int i = curr_thread->id+1; count<MAX_UTHREADS; count++, i=(i+1)%MAX_UTHREADS) {
    14cc:	00001517          	auipc	a0,0x1
    14d0:	b4c53503          	ld	a0,-1204(a0) # 2018 <curr_thread>
    14d4:	411c                	lw	a5,0(a0)
    14d6:	2785                	addiw	a5,a5,1
    14d8:	4691                	li	a3,4
    enum sched_priority max_priority = LOW;
    14da:	4301                	li	t1,0
    struct uthread *next_thread = (struct uthread *) 1;
    ...
    14e2:	c3a60613          	addi	a2,a2,-966 # 2118 <uthreads_arr>
    14e6:	6805                	lui	a6,0x1
    14e8:	4889                	li	a7,2
    14ea:	a819                	j	1500 <uthread_yield+0x34>
    for (int i = curr_thread->id+1; count<MAX_UTHREADS; count++, i=(i+1)%MAX_UTHREADS) {
    14ec:	2785                	addiw	a5,a5,1
    14ee:	41f7d71b          	sraiw	a4,a5,0x1f
    14f2:	01e7571b          	srliw	a4,a4,0x1e
    14f6:	9fb9                	addw	a5,a5,a4
    14f8:	8b8d                	andi	a5,a5,3
    14fa:	9f99                	subw	a5,a5,a4
    14fc:	36fd                	addiw	a3,a3,-1
    14fe:	ca9d                	beqz	a3,1534 <uthread_yield+0x68>
        if (uthreads_arr[i].state == RUNNABLE &&
    1500:	00779713          	slli	a4,a5,0x7
    1504:	973e                	add	a4,a4,a5
    1506:	0716                	slli	a4,a4,0x5
    1508:	9732                	add	a4,a4,a2
    150a:	9742                	add	a4,a4,a6
    150c:	fa472703          	lw	a4,-92(a4)
    1510:	fd171ee3          	bne	a4,a7,14ec <uthread_yield+0x20>
            uthreads_arr[i].priority > max_priority) {
    1514:	00779713          	slli	a4,a5,0x7
    1518:	973e                	add	a4,a4,a5
    151a:	0716                	slli	a4,a4,0x5
    151c:	9732                	add	a4,a4,a2
    151e:	9742                	add	a4,a4,a6
    1520:	4f18                	lw	a4,24(a4)
        if (uthreads_arr[i].state == RUNNABLE &&
    1522:	fce375e3          	bgeu	t1,a4,14ec <uthread_yield+0x20>
            next_thread = &uthreads_arr[i];
    1526:	00779593          	slli	a1,a5,0x7
    152a:	95be                	add	a1,a1,a5
    152c:	0596                	slli	a1,a1,0x5
    152e:	95b2                	add	a1,a1,a2
            max_priority = uthreads_arr[i].priority;
    1530:	833a                	mv	t1,a4
    1532:	bf6d                	j	14ec <uthread_yield+0x20>
    if (next_thread == (struct uthread *) 1) {
    1534:	4785                	li	a5,1
    1536:	04f58163          	beq	a1,a5,1578 <uthread_yield+0xac>
void uthread_yield() {
    153a:	1141                	addi	sp,sp,-16
    153c:	e406                	sd	ra,8(sp)
    153e:	e022                	sd	s0,0(sp)
    1540:	0800                	addi	s0,sp,16
    curr_thread->state = RUNNABLE;
    1542:	6785                	lui	a5,0x1
    1544:	00f50733          	add	a4,a0,a5
    1548:	4689                	li	a3,2
    154a:	fad72223          	sw	a3,-92(a4)
    next_thread->state = RUNNING;
    154e:	00f58733          	add	a4,a1,a5
    1552:	4685                	li	a3,1
    1554:	fad72223          	sw	a3,-92(a4)
    curr_thread = next_thread;
    1558:	00001717          	auipc	a4,0x1
    155c:	acb73023          	sd	a1,-1344(a4) # 2018 <curr_thread>
    struct context *next_context = &next_thread->context;
    1560:	fa878793          	addi	a5,a5,-88 # fa8 <vprintf+0x36>
    uswtch(curr_context, next_context);
    1564:	95be                	add	a1,a1,a5
    1566:	953e                	add	a0,a0,a5
    1568:	00000097          	auipc	ra,0x0
    156c:	db8080e7          	jalr	-584(ra) # 1320 <uswtch>
}
    1570:	60a2                	ld	ra,8(sp)
    1572:	6402                	ld	s0,0(sp)
    1574:	0141                	addi	sp,sp,16
    1576:	8082                	ret
    1578:	8082                	ret

000000000000157a <uthread_set_priority>:

enum sched_priority uthread_set_priority(enum sched_priority priority){
    157a:	1141                	addi	sp,sp,-16
    157c:	e422                	sd	s0,8(sp)
    157e:	0800                	addi	s0,sp,16
    enum sched_priority to_return =curr_thread->priority;
    1580:	00001797          	auipc	a5,0x1
    1584:	a987b783          	ld	a5,-1384(a5) # 2018 <curr_thread>
    1588:	6705                	lui	a4,0x1
    158a:	97ba                	add	a5,a5,a4
    158c:	4f98                	lw	a4,24(a5)
    curr_thread->priority=priority;
    158e:	cf88                	sw	a0,24(a5)
    return to_return;
}
    1590:	853a                	mv	a0,a4
    1592:	6422                	ld	s0,8(sp)
    1594:	0141                	addi	sp,sp,16
    1596:	8082                	ret

0000000000001598 <uthread_get_priority>:

enum sched_priority uthread_get_priority(){
    1598:	1141                	addi	sp,sp,-16
    159a:	e422                	sd	s0,8(sp)
    159c:	0800                	addi	s0,sp,16
    return curr_thread->priority;
    159e:	00001797          	auipc	a5,0x1
    15a2:	a7a7b783          	ld	a5,-1414(a5) # 2018 <curr_thread>
    15a6:	6705                	lui	a4,0x1
    15a8:	97ba                	add	a5,a5,a4
}
    15aa:	4f88                	lw	a0,24(a5)
    15ac:	6422                	ld	s0,8(sp)
    15ae:	0141                	addi	sp,sp,16
    15b0:	8082                	ret

00000000000015b2 <uthread_start_all>:

int uthread_start_all(){
    if (started){
    15b2:	00001797          	auipc	a5,0x1
    15b6:	a6e7a783          	lw	a5,-1426(a5) # 2020 <started>
    15ba:	ebc5                	bnez	a5,166a <uthread_start_all+0xb8>
int uthread_start_all(){
    15bc:	1141                	addi	sp,sp,-16
    15be:	e406                	sd	ra,8(sp)
    15c0:	e022                	sd	s0,0(sp)
    15c2:	0800                	addi	s0,sp,16
        return -1;
    }
    started=1;
    15c4:	4785                	li	a5,1
    15c6:	00001717          	auipc	a4,0x1
    15ca:	a4f72d23          	sw	a5,-1446(a4) # 2020 <started>
    struct uthread *next_thread = (struct uthread *) 1;
    enum sched_priority max_priority = LOW;
    int count=0;
    for (int i = curr_thread->id+1; count<MAX_UTHREADS;  count++,i=(i+1)%MAX_UTHREADS) {
    15ce:	00001797          	auipc	a5,0x1
    15d2:	a4a7b783          	ld	a5,-1462(a5) # 2018 <curr_thread>
    15d6:	439c                	lw	a5,0(a5)
    15d8:	2785                	addiw	a5,a5,1
    15da:	4691                	li	a3,4
    enum sched_priority max_priority = LOW;
    15dc:	4881                	li	a7,0
    struct uthread *next_thread = (struct uthread *) 1;
    15de:	4605                	li	a2,1
        ...
        if (uthreads_arr[i].state == RUNNABLE &&
    15e0:	00001597          	auipc	a1,0x1
    15e4:	b3858593          	addi	a1,a1,-1224 # 2118 <uthreads_arr>
    15e8:	6505                	lui	a0,0x1
    15ea:	4809                	li	a6,2
    15ec:	a819                	j	1602 <uthread_start_all+0x50>
    for (int i = curr_thread->id+1; count<MAX_UTHREADS;  count++,i=(i+1)%MAX_UTHREADS) {
    15ee:	2785                	addiw	a5,a5,1
    15f0:	41f7d71b          	sraiw	a4,a5,0x1f
    15f4:	01e7571b          	srliw	a4,a4,0x1e
    15f8:	9fb9                	addw	a5,a5,a4
    15fa:	8b8d                	andi	a5,a5,3
    15fc:	9f99                	subw	a5,a5,a4
    15fe:	36fd                	addiw	a3,a3,-1
    1600:	ca9d                	beqz	a3,1636 <uthread_start_all+0x84>
        if (uthreads_arr[i].state == RUNNABLE &&
    1602:	00779713          	slli	a4,a5,0x7
    1606:	973e                	add	a4,a4,a5
    1608:	0716                	slli	a4,a4,0x5
    160a:	972e                	add	a4,a4,a1
    160c:	972a                	add	a4,a4,a0
    160e:	fa472703          	lw	a4,-92(a4)
    1612:	fd071ee3          	bne	a4,a6,15ee <uthread_start_all+0x3c>
            uthreads_arr[i].priority > max_priority) {
    1616:	00779713          	slli	a4,a5,0x7
    161a:	973e                	add	a4,a4,a5
    161c:	0716                	slli	a4,a4,0x5
    161e:	972e                	add	a4,a4,a1
    1620:	972a                	add	a4,a4,a0
    1622:	4f18                	lw	a4,24(a4)
        if (uthreads_arr[i].state == RUNNABLE &&
    1624:	fce8f5e3          	bgeu	a7,a4,15ee <uthread_start_all+0x3c>
            next_thread = &uthreads_arr[i];
    1628:	00779613          	slli	a2,a5,0x7
    162c:	963e                	add	a2,a2,a5
    162e:	0616                	slli	a2,a2,0x5
    1630:	962e                	add	a2,a2,a1
            max_priority = uthreads_arr[i].priority;
    1632:	88ba                	mv	a7,a4
    1634:	bf6d                	j	15ee <uthread_start_all+0x3c>
        }
    }
    struct context *next_context = &next_thread->context;
    next_thread->state = RUNNING;
    1636:	6585                	lui	a1,0x1
    1638:	00b607b3          	add	a5,a2,a1
    163c:	4705                	li	a4,1
    163e:	fae7a223          	sw	a4,-92(a5)
    curr_thread = next_thread;
    1642:	00001797          	auipc	a5,0x1
    1646:	9cc7bb23          	sd	a2,-1578(a5) # 2018 <curr_thread>
    struct context *next_context = &next_thread->context;
    164a:	fa858593          	addi	a1,a1,-88 # fa8 <vprintf+0x36>
    uswtch(&garbageContext,next_context);
    164e:	95b2                	add	a1,a1,a2
    1650:	00001517          	auipc	a0,0x1
    1654:	a5850513          	addi	a0,a0,-1448 # 20a8 <garbageContext>
    1658:	00000097          	auipc	ra,0x0
    165c:	cc8080e7          	jalr	-824(ra) # 1320 <uswtch>
...
000000000000166e <uthread_self>:

struct uthread* uthread_self(){
    166e:	1141                	addi	sp,sp,-16
    1670:	e422                	sd	s0,8(sp)
    1672:	0800                	addi	s0,sp,16
    return curr_thread;
    1674:	00001517          	auipc	a0,0x1
    1678:	9a453503          	ld	a0,-1628(a0) # 2018 <curr_thread>
    167c:	6422                	ld	s0,8(sp)
    167e:	0141                	addi	sp,sp,16
    1680:	8082                	ret
