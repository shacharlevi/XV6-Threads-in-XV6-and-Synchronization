...
main(int argc, char *argv[])
{
  ...
  14:	b8058593          	addi	a1,a1,-1152 # b90 <uthread_self+0x18>
  18:	4509                	li	a0,2
  ...
  50:	b5c58593          	addi	a1,a1,-1188 # ba8 <uthread_self+0x30>
  54:	4509                	li	a0,2
...
0000000000000388 <kthread_create>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f8:	7d450513          	addi	a0,a0,2004 # bc8 <digits>
 3fc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c4:	708b8b93          	addi	s7,s7,1800 # bc8 <digits>
 ...
 604:	5c090913          	addi	s2,s2,1472 # bc0 <uthread_self+0x48>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7a2:	88278793          	addi	a5,a5,-1918 # 1020 <base>
...
000000000000082a <uswtch>:
 82a:	00153023          	sd	ra,0(a0)
 82e:	00253423          	sd	sp,8(a0)
 832:	e900                	sd	s0,16(a0)
 834:	ed04                	sd	s1,24(a0)
 836:	03253023          	sd	s2,32(a0)
 83a:	03353423          	sd	s3,40(a0)
 83e:	03453823          	sd	s4,48(a0)
 842:	03553c23          	sd	s5,56(a0)
 846:	05653023          	sd	s6,64(a0)
 84a:	05753423          	sd	s7,72(a0)
 84e:	05853823          	sd	s8,80(a0)
 852:	05953c23          	sd	s9,88(a0)
 856:	07a53023          	sd	s10,96(a0)
 85a:	07b53423          	sd	s11,104(a0)
 85e:	0005b083          	ld	ra,0(a1)
 862:	0085b103          	ld	sp,8(a1)
 866:	6980                	ld	s0,16(a1)
 868:	6d84                	ld	s1,24(a1)
 86a:	0205b903          	ld	s2,32(a1)
 86e:	0285b983          	ld	s3,40(a1)
 872:	0305ba03          	ld	s4,48(a1)
 876:	0385ba83          	ld	s5,56(a1)
 87a:	0405bb03          	ld	s6,64(a1)
 87e:	0485bb83          	ld	s7,72(a1)
 882:	0505bc03          	ld	s8,80(a1)
 886:	0585bc83          	ld	s9,88(a1)
 88a:	0605bd03          	ld	s10,96(a1)
 88e:	0685bd83          	ld	s11,104(a1)
 892:	8082                	ret

0000000000000894 <uthread_exit>:
...
void uthread_exit(){
 ...
 8a0:	34450513          	addi	a0,a0,836 # be0 <digits+0x18>
 8a4:	00000097          	auipc	ra,0x0
 8a8:	de4080e7          	jalr	-540(ra) # 688 <printf>
 ...
 8b8:	fa07a223          	sw	zero,-92(a5) # fa4 <digits+0x3dc>
 ...
 8ce:	6805                	lui	a6,0x1
 8d0:	4889                	li	a7,2
 8d2:	a819                	j	8e8 <uthread_exit+0x54>
    for (int i = curr_thread->id+1; count<MAX_UTHREADS;  count++,i=(i+1)%MAX_UTHREADS) {
 ...
 8e6:	ca9d                	beqz	a3,91c <uthread_exit+0x88>
        if (uthreads_arr[i].state == RUNNABLE &&
 ...
 8f8:	fd171ee3          	bne	a4,a7,8d4 <uthread_exit+0x40>
 ...
 908:	4f18                	lw	a4,24(a4)
        if (uthreads_arr[i].state == RUNNABLE &&
 90a:	fce375e3          	bgeu	t1,a4,8d4 <uthread_exit+0x40>
 ...
 918:	833a                	mv	t1,a4
 91a:	bf6d                	j	8d4 <uthread_exit+0x40>
        }
    }
    if (next_thread == (struct uthread *) 1) {
 91c:	4785                	li	a5,1
 91e:	02f58863          	beq	a1,a5,94e <uthread_exit+0xba>
 ...
 932:	6cb73d23          	sd	a1,1754(a4) # 1008 <curr_thread>
    struct context *next_context = &next_thread->context;
 936:	fa878793          	addi	a5,a5,-88 # fa8 <digits+0x3e0>
    uswtch(curr_context, next_context);
 93a:	95be                	add	a1,a1,a5
 93c:	953e                	add	a0,a0,a5
 93e:	00000097          	auipc	ra,0x0
 942:	eec080e7          	jalr	-276(ra) # 82a <uswtch>
}
 946:	60a2                	ld	ra,8(sp)
 948:	6402                	ld	s0,0(sp)
 ...
 954:	998080e7          	jalr	-1640(ra) # 2e8 <exit>
...
int uthread_create(void (*start_func)(), enum sched_priority priority) {
 ...
 9ae:	fa468693          	addi	a3,a3,-92 # fa4 <digits+0x3dc>
 ...
 9bc:	edc70713          	addi	a4,a4,-292 # 894 <uthread_exit>
...
void uthread_yield() {
 ...
 a66:	5ab73323          	sd	a1,1446(a4) # 1008 <curr_thread>
    struct context *next_context = &next_thread->context;
 a6a:	fa878793          	addi	a5,a5,-88 # fa8 <digits+0x3e0>
    uswtch(curr_context, next_context);
 a6e:	95be                	add	a1,a1,a5
 a70:	953e                	add	a0,a0,a5
 a72:	00000097          	auipc	ra,0x0
 a76:	db8080e7          	jalr	-584(ra) # 82a <uswtch>
}
 a7a:	60a2                	ld	ra,8(sp)
 a7c:	6402                	ld	s0,0(sp)
...
int uthread_start_all(){
 ...
 b50:	4ac7be23          	sd	a2,1212(a5) # 1008 <curr_thread>
    struct context *next_context = &next_thread->context;
 b54:	fa858593          	addi	a1,a1,-88 # fa8 <digits+0x3e0>
 ...
 b66:	cc8080e7          	jalr	-824(ra) # 82a <uswtch>
...
struct uthread* uthread_self(){
 ...
 b82:	48a53503          	ld	a0,1162(a0) # 1008 <curr_thread>
 b86:	6422                	ld	s0,8(sp)
